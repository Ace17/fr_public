...
sBool bOpenSelector(const bSelectorSetup& setup, bSelectorResult& result)
{
  ...
  static const sScreenInfoXY defaultaspects[] =
  {
    { 4, 3 }, { 5, 4 }, { 16, 10 }, { 16, 9 }
  };
  ...
  sInt ww = (wrect.right - wrect.left);
  ww += W - (crect.right - crect.left);
  sInt wh = (wrect.bottom - wrect.top);
  wh += H - (crect.bottom - crect.top);
