...
struct Wz4Particle
{
  ...
  void Init(const sVector31& p, sF32 t)
  {
    Pos = p;
    Time = t;
  }

  void Get(sVector31& p, sF32& t)
  {
    p = Pos;
    t = Time;
  }

  void Get(sVector31& p)
  {
    p = Pos;
  }
};
...
public:
  ...
  virtual void Simulate(Wz4RenderContext* ctx)
  {
    SimulateCalc(ctx);
  }

  virtual sInt GetPartCount()
  {
    return 0;
  }

  virtual sInt GetPartFlags()
  {
    return 0;
  }

  virtual void Func(Wz4PartInfo& pinfo, sF32 time, sF32 dt)
  {
  }; // calc particles for time, return number of alive particles
