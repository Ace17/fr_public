...
public:
  ...
  void TransformRange(sInt rangeMode, sInt mode, sInt selection, sVector2 direction, sVector2 axialRange, sVector31 scaleStart, sVector30 rotateStart, sVector31 translateStart, sVector31 scaleEnd, sVector30 rotateEnd, sVector31 translateEnd);
