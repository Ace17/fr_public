...
public:
  ...
  void InitSize(GenBitmap* s)
  {
    Init(s->XSize, s->YSize);
    Atlas.Entries.Copy(s->Atlas.Entries);
  }
  ...
  sBool Incompatible(GenBitmap* b)
  {
    return XSize != b->XSize || YSize != b->YSize;
  }
  ...
  void Bump(GenBitmap* bb, sInt subcode, sF32 px, sF32 py, sF32 pz, sF32 da, sF32 db, sU32 _diff, sU32 _ambi, sF32 outer, sF32 falloff, sF32 amp, sU32 _spec, sF32 spow, sF32 samp);
