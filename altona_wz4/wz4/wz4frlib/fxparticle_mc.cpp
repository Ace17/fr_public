...
// sInt size = (s+2)*(s+1)*(s+1);
    ...
    if(subdiv == 0)                 // none
    {
      ...
      switch(base)
      {
      case 0: MC.March_0_1(pot, S, tpos, thread);
        break;
      case 1: MC.March_1_1(pot, S, tpos, thread);
        break;
      case 2: MC.March_2_1(pot, S, tpos, thread);
        break;
      case 3: MC.March_3_1(pot, S, tpos, thread);
        break;
      case 4: MC.March_4_1(pot, S, tpos, thread);
        break;
      case 5: MC.March_5_1(pot, S, tpos, thread);
        break;
    ...
    else                          // subdiv once
    {
      ...
      for(sInt z = 0; z < s; z++)
      {
        ...
        for(sInt y = 0; y < s; y++)
        {
          ...
          {
            sU32 flo, ma, mo;
            flo = *(sU32*)&pot[(z + 0) * mm + (y + 0) * m + (x + 0)].w;
            ma = flo;
            mo = flo;
            flo = *(sU32*)&pot[(z + 0) * mm + (y + 0) * m + (x + 1)].w;
            ma &= flo;
            mo |= flo;
            flo = *(sU32*)&pot[(z + 0) * mm + (y + 1) * m + (x + 0)].w;
            ma &= flo;
            mo |= flo;
            flo = *(sU32*)&pot[(z + 0) * mm + (y + 1) * m + (x + 1)].w;
            ma &= flo;
            mo |= flo;
            flo = *(sU32*)&pot[(z + 1) * mm + (y + 0) * m + (x + 0)].w;
            ma &= flo;
            mo |= flo;
            flo = *(sU32*)&pot[(z + 1) * mm + (y + 0) * m + (x + 1)].w;
            ma &= flo;
            mo |= flo;
            flo = *(sU32*)&pot[(z + 1) * mm + (y + 1) * m + (x + 0)].w;
            ma &= flo;
            mo |= flo;
            flo = *(sU32*)&pot[(z + 1) * mm + (y + 1) * m + (x + 1)].w;
            ma &= flo;
            mo |= flo;
            ...
            if((ma & 0x80000000) == 0 && (mo & 0x80000000) != 0)
            {
              ...
              {
                v = sVector30(x + 0.0f, y + 0.0f, z + 0.5f) * S + tpos;
                func(v, pot2[1][0][0], fi);
                v = sVector30(x + 0.0f, y + 0.5f, z + 0.0f) * S + tpos;
                func(v, pot2[0][1][0], fi);
                v = sVector30(x + 0.0f, y + 0.5f, z + 0.5f) * S + tpos;
                func(v, pot2[1][1][0], fi);
                v = sVector30(x + 0.0f, y + 0.5f, z + 1.0f) * S + tpos;
                func(v, pot2[2][1][0], fi);
                v = sVector30(x + 0.0f, y + 1.0f, z + 0.5f) * S + tpos;
                func(v, pot2[1][2][0], fi);
              }
              ...
              {
                v = sVector30(x + 0.5f, y + 0.0f, z + 0.0f) * S + tpos;
                func(v, pot2[0][0][1], fi);
                v = sVector30(x + 0.5f, y + 0.0f, z + 0.5f) * S + tpos;
                func(v, pot2[1][0][1], fi);
                v = sVector30(x + 0.5f, y + 0.0f, z + 1.0f) * S + tpos;
                func(v, pot2[2][0][1], fi);
                v = sVector30(x + 1.0f, y + 0.0f, z + 0.5f) * S + tpos;
                func(v, pot2[1][0][2], fi);
              }

              v = sVector30(x + 0.5f, y + 1.0f, z + 0.0f) * S + tpos;
              func(v, pot2[0][2][1], fi);
              pot2y[x][0] = pot2[0][2][1];
              v = sVector30(x + 0.5f, y + 1.0f, z + 0.5f) * S + tpos;
              func(v, pot2[1][2][1], fi);
              pot2y[x][1] = pot2[1][2][1];
              v = sVector30(x + 0.5f, y + 1.0f, z + 1.0f) * S + tpos;
              func(v, pot2[2][2][1], fi);
              pot2y[x][2] = pot2[2][2][1];
              v = sVector30(x + 1.0f, y + 1.0f, z + 0.5f) * S + tpos;
              func(v, pot2[1][2][2], fi);
              pot2y[x][3] = pot2[1][2][2];
              LastY = y;
              lastyz[x] = z;

              // do the rest, don't bother caching

              v = sVector30(x + 0.5f, y + 0.5f, z + 0.0f) * S + tpos;
              func(v, pot2[0][1][1], fi);
              v = sVector30(x + 0.5f, y + 0.5f, z + 0.5f) * S + tpos;
              func(v, pot2[1][1][1], fi);
              v = sVector30(x + 0.5f, y + 0.5f, z + 1.0f) * S + tpos;
              func(v, pot2[2][1][1], fi);

              v = sVector30(x + 1.0f, y + 0.5f, z + 0.0f) * S + tpos;
              func(v, pot2[0][1][2], fi);
              v = sVector30(x + 1.0f, y + 0.5f, z + 0.5f) * S + tpos;
              func(v, pot2[1][1][2], fi);
              v = sVector30(x + 1.0f, y + 0.5f, z + 1.0f) * S + tpos;
              func(v, pot2[2][1][2], fi);
...
void RNMarchingCubesBase<T>::Render()
{
  ...
  if(Para.Subdivide)
  {
    ...
    {
    case 0: code = StaticRenderT<T, 0, 1>;
      break;
    case 1: code = StaticRenderT<T, 1, 1>;
      break;
    case 2: code = StaticRenderT<T, 2, 1>;
      break;
    case 3: code = StaticRenderT<T, 3, 1>;
      break;
    case 4: code = StaticRenderT<T, 4, 1>;
      break;
    case 5: code = StaticRenderT<T, 5, 1>;
      break;
    }
  }
  else
  {
    switch(Para.BaseGrid)
    {
    case 0: code = StaticRenderT<T, 0, 0>;
      break;
    case 1: code = StaticRenderT<T, 1, 0>;
      break;
    case 2: code = StaticRenderT<T, 2, 0>;
      break;
    case 3: code = StaticRenderT<T, 3, 0>;
      break;
    case 4: code = StaticRenderT<T, 4, 0>;
      break;
    case 5: code = StaticRenderT<T, 5, 0>;
      break;
    }
  }
...
void RNMarchingCubesBase<T>::Render(Wz4RenderContext* ctx)
{
  ...
  {
    if(Mtrl->SkipPhase(ctx->RenderMode, Para.LightEnv & 15))
      return;
