...
struct sMemberPtr
{
  ...
  ElementType& Ref(void* obj)
  {
    return *(ElementType*)(((sU8*)obj) + Offset);
  }
};
...
template<class Type>
sINLINE Type sMin(Type a, Type b)
{
  return (a < b) ? a : b;
}

template<class Type>
sINLINE Type sMax(Type a, Type b)
{
  return (a > b) ? a : b;
}

template<class Type>
sINLINE Type sMin3(Type a, Type b, Type c)
{
  return sMin(sMin(a, b), c);
}

template<class Type>
sINLINE Type sMax3(Type a, Type b, Type c)
{
  return sMax(sMax(a, b), c);
}

template<class Type>
sINLINE Type sSign(Type a)
{
  return (a == 0) ? Type(0) : (a > 0) ? Type(1) : Type(-1);
}

template<class Type>
sINLINE Type sCompare(Type a, Type b)
{
  return (a > b) ? 1 : ((a == b) ? 0 : -1);
}

template<class Type>
sINLINE Type sClamp(Type a, Type min, Type max)
{
  return (a >= max) ? max : (a <= min) ? min : a;
}

template<class Type>
sINLINE sBool sIsInRangeIncl(Type a, Type min, Type max)
{
  return (min <= a) && (a <= max);
}

template<class Type>
sINLINE sBool sIsInRangeExcl(Type a, Type min, Type max)
{
  return (min <= a) && (a < max);
}

template<class Type>
sINLINE void sSwap(Type& a, Type& b)
{
  Type s = a;
  a = b;
  b = s;
...
template<class Type>
sINLINE Type sAlign(Type a, sInt b)
{
  typedef sInt check[(sizeof(Type) <= sizeof(sDInt)) ? 1 : -1];
  return (Type)((((sDInt)a) + b - 1) & (~(b - 1)));
} // doesn't work correctly if sizeof(sDInt)<sizeof(Type)

sINLINE sS64 sAlign(sS64 a, sInt b)
{
  return (a + b - 1) & (~(b - 1));
}

sINLINE sU64 sAlign(sU64 a, sInt b)
{
  return (a + b - 1) & (~(b - 1));
}

template<class Type>
sINLINE Type sSquare(Type a)
{
  return a * a;
}
...
inline sBool sIsPower2(sInt x)
{
  return (x & (x - 1)) == 0;
}

inline sInt sDivDown(sInt a, sInt b)
{
  return a > 0 ? a / b : -(-a / b);
}

template<class Type>
sINLINE void sDelete(Type& a)
{
  if(a)
    delete a;
...
template<class Type>
sINLINE void sDeleteArray(Type& a)
{
  if(a)
    delete[] a;
...
template<class Type>
sINLINE Type sFade(sF32 f, Type a, Type b)
{
  return (Type)(a + (b - a) * f);
}

template<class Type>
sINLINE Type sFadeBilin(sF32 u, sF32 v, Type x00, Type x01, Type x10, Type x11)
{
  return sFade(v, sFade(u, x00, x01), sFade(u, x10, x11));
}
...
inline void sSwapEndianI(sU32& a)
{
  a = ((a & 0xff000000) >> 24) | ((a & 0x00ff0000) >> 8) | ((a & 0x0000ff00) << 8) | ((a & 0x000000ff) << 24);
}

inline void sSwapEndianI(sU16& a)
{
  a = ((a & 0xff00) >> 8) | ((a & 0x00ff) << 8);
}

inline void sSwapEndianI(sU64& a)
{
  a = sSwapEndian(a);
}

inline sInt sSwapEndian(sInt a)
{
  sU32 tmp = *(sU32*)&a;
  sSwapEndianI(tmp);
  a = *(sInt*)&tmp;
...
inline sF32 sSwapEndian(sF32 a)
{
  sU32 tmp = *(sU32*)&a;
  sSwapEndianI(tmp);
  a = *(sF32*)&tmp;
...
#if sCONFIG_BE
inline sU32 sSwapIfBE(sU32 a)
{
  return ((a & 0xff000000) >> 24) | ((a & 0x00ff0000) >> 8) | ((a & 0x0000ff00) << 8) | ((a & 0x000000ff) << 24);
}

inline sU32 sSwapIfLE(sU32 a)
{
  return a;
}

inline sU16 sSwapIfBE(sU16 a)
{
  return ((a & 0xff00) >> 8) | ((a & 0x00ff) << 8);
}

inline sU16 sSwapIfLE(sU16 a)
{
  return a;
}

inline sU64 sSwapIfBE(sU64 a)
{
  return sU64(sSwapEndian(sU32(a))) << 32 | sU64(sSwapEndian(sU32(a >> 32)));
}

inline sU64 sSwapIfLE(sU64 a)
{
  return a;
}

inline sInt sSwapIfBE(sInt a)
{
  return sSwapEndian(a);
}

inline sInt sSwapIfLE(sInt a)
{
  return a;
}

inline sF32 sSwapIfBE(sF32 a)
{
  return sSwapEndian(a);
}

inline sF32 sSwapIfLE(sF32 a)
{
  return a;
}

inline void sUnalignedLittleEndianStore16(sU8* p, sU16 v)
{
  p[0] = sU8(v);
  p[1] = sU8(v >> 8);
}

inline void sUnalignedLittleEndianStore32(sU8* p, sU32 v)
{
  p[0] = sU8(v);
  p[1] = sU8(v >> 8);
  p[2] = sU8(v >> 16);
...
inline void sUnalignedLittleEndianStore64(sU8* p, sU64 v)
{
  p[0] = sU8(v);
  p[1] = sU8(v >> 8);
  p[2] = sU8(v >> 16);
...
inline void sUnalignedLittleEndianLoad16(const sU8* p, sU16& v)
{
  sU8* s = (sU8*)&v;
  s[0] = p[1];
  s[1] = p[0];
...
inline void sUnalignedLittleEndianLoad32(const sU8* p, sU32& v)
{
  sU8* s = (sU8*)&v;
  s[0] = p[3];
  s[1] = p[2];
...
inline void sUnalignedLittleEndianLoad64(const sU8* p, sU64& v)
{
  sU8* s = (sU8*)&v;
  s[0] = p[7];
  s[1] = p[6];
...
// raw cast
template<typename T, sInt Bytes>
struct sSwapHelper;
template<typename T0, typename T1>
struct sRawCastHelper
{
...
T0 raw_cast(T1 v1)
{
  sRawCastHelper<T0, T1> tmp(v1);
  return tmp.V0;
}

// template endian swapper
// if this work on all compilers explicit swap permutations can be removed
template<typename T, sInt S>
struct sSwapEndianHelper;
template<typename T>
struct sSwapEndianHelper<T, 1>
{
  static T Swap(T a)
  {
    return a;
...
template<typename T>
struct sSwapEndianHelper<T, 2>
{
  static T Swap(T a)
  {
    return raw_cast<T>(sSwapEndian(raw_cast<sU16>(a)));
  }
};
template<typename T>
struct sSwapEndianHelper<T, 4>
{
  static T Swap(T a)
  {
    return raw_cast<T>(sSwapEndian(raw_cast<sU32>(a)));
  }
};
template<typename T>
struct sSwapEndianHelper<T, 8>
{
  static T Swap(T a)
  {
    return raw_cast<T>(sSwapEndian(raw_cast<sU64>(a)));
  }
};
...
T sSwapIfBE(T a)
{
  return sSwapEndianHelper<T, sizeof(T)>::Swap(a);
}
...
sINLINE sF32 /*sOBSOLETE*/ sFMod(sF32 a, sF32 b)
{
  return sMod(a, b);
}

sINLINE sF32 /*sOBSOLETE*/ sFFloor(sF32 a)
{
  return sRoundDown(a);
}

sINLINE sF32 /*sOBSOLETE*/ sFCeil(sF32 a)
{
  return sRoundUp(a);
}

sINLINE sF32 /*sOBSOLETE*/ sFAbs(sF32 a)
{
  return sAbs(a);
}

sINLINE sF32 /*sOBSOLETE*/ sFInvSqrt(sF32 a)
{
  return sRSqrt(a);
}
...
sINLINE sInt sFloorLog2(sF32 x)
{
  union
  {
    sF32 f;
...
sINLINE sInt sCountBits(sU32 bits)
{
  sInt count = 0;
...
sINLINE sU32 sEncodeMorton2(sU32 x, sU32 y)
{
  return (sPart1By1(y) << 1) + sPart1By1(x);
}

sINLINE sU32 sEncodeMorton3(sU32 x, sU32 y, sU32 z)
{
  return (sPart1By2(z) << 2) + (sPart1By2(y) << 1) + sPart1By2(x);
}

sINLINE sU32 sDecodeMorton2X(sU32 index)
{
  return sCompact1By1(index >> 0);
}

sINLINE sU32 sDecodeMorton2Y(sU32 index)
{
  return sCompact1By1(index >> 1);
}

sINLINE sU32 sDecodeMorton2(sU32 index, sInt axis)
{
  return sCompact1By1(index >> axis);
}

sINLINE sU32 sDecodeMorton3X(sU32 index)
{
  return sCompact1By2(index >> 0);
}

sINLINE sU32 sDecodeMorton3Y(sU32 index)
{
  return sCompact1By2(index >> 1);
}

sINLINE sU32 sDecodeMorton3Z(sU32 index)
{
  return sCompact1By2(index >> 2);
}

sINLINE sU32 sDecodeMorton3(sU32 index, sInt axis)
{
  return sCompact1By2(index >> axis);
}
...
struct sStringDesc                // this is always used as CONST, otherwise it won't work correctly.
{
  ...
  sStringDesc & operator = (const sStringDesc& s)
  {
    Buffer = s.Buffer;
    Size = s.Size;
    return *this;
...
inline void sCopyString(const sStringDesc& d, const sChar* s)
{
  sCopyString(d.Buffer, s, d.Size);
}
...
inline void sCopyString(const sStringDesc& d, const sChar8* s)
{
  sCopyString(d.Buffer, s, d.Size);
}
...
sINLINE sInt sGetStringLen(const sChar* s)
{
  sInt i;
...
inline void sAppendString(const sStringDesc& d, const sChar* s)
{
  sAppendString(d.Buffer, s, d.Size);
}
...
inline void sAppendPath(const sStringDesc& d, const sChar* s)
{
  sAppendPath(d.Buffer, s, d.Size);
}
...
inline void sReadString(sU32*& data, const sStringDesc& desc)
{
  sReadString(data, desc.Buffer, desc.Size);
}

void sWriteString(sU32*& data, const sChar* buffer);

inline sBool sIsDigit(sInt i)
{
  return i >= '0' && i <= '9';
}

inline sBool sIsLetter(sInt i)
{
  return (i >= 'a' && i <= 'z') || (i >= 'A' && i <= 'Z') || i == '_';
}

inline sBool sIsSpace(sInt i)
{
  return i == ' ' || i == '\t' || i == '\r' || i == '\n';
}

inline sBool sIsHex(sInt i)
{
...
inline void sScanSpace(const sChar*& scan)
{
  while(sIsSpace(*scan))
    scan++;
}
...
struct sFormatStringBuffer
{
  ...
  void PrintInt(const sFormatStringInfo& info, Type v, sBool sign);
...
#define sPRINTING0(Symbol, PreImpl, PostImpl) \
  ...
  inline void Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j) { PreImpl % a % b % c % d % e % f % g % h % i % j; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I> \
  inline void Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i) { PreImpl % a % b % c % d % e % f % g % h % i; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H> \
  inline void Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h) { PreImpl % a % b % c % d % e % f % g % h; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G> \
  inline void Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g) { PreImpl % a % b % c % d % e % f % g; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F> \
  inline void Symbol(const sChar * format, A a, B b, C c, D d, E e, F f) { PreImpl % a % b % c % d % e % f; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E> \
  inline void Symbol(const sChar * format, A a, B b, C c, D d, E e) { PreImpl % a % b % c % d % e; PostImpl } \
  template<typename A, typename B, typename C, typename D> \
  inline void Symbol(const sChar * format, A a, B b, C c, D d) { PreImpl % a % b % c % d; PostImpl } \
  template<typename A, typename B, typename C> \
  inline void Symbol(const sChar * format, A a, B b, C c) { PreImpl % a % b % c; PostImpl } \
  template<typename A, typename B> \
  inline void Symbol(const sChar * format, A a, B b) { PreImpl % a % b; PostImpl } \
  template<typename A> \
  inline void Symbol(const sChar * format, A a) { PreImpl % a; PostImpl } \
/*                                                                                                                   */ inline void Symbol(const sChar * format) { PreImpl % 0; PostImpl }

#define sPRINTING0R(rtype, Symbol, PreImpl, PostImpl) \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I, typename J> \
  inline rtype Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j) { PreImpl % a % b % c % d % e % f % g % h % i % j; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I> \
  inline rtype Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i) { PreImpl % a % b % c % d % e % f % g % h % i; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H> \
  inline rtype Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h) { PreImpl % a % b % c % d % e % f % g % h; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G> \
  inline rtype Symbol(const sChar * format, A a, B b, C c, D d, E e, F f, G g) { PreImpl % a % b % c % d % e % f % g; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F> \
  inline rtype Symbol(const sChar * format, A a, B b, C c, D d, E e, F f) { PreImpl % a % b % c % d % e % f; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E> \
  inline rtype Symbol(const sChar * format, A a, B b, C c, D d, E e) { PreImpl % a % b % c % d % e; PostImpl } \
  template<typename A, typename B, typename C, typename D> \
  inline rtype Symbol(const sChar * format, A a, B b, C c, D d) { PreImpl % a % b % c % d; PostImpl } \
  template<typename A, typename B, typename C> \
  inline rtype Symbol(const sChar * format, A a, B b, C c) { PreImpl % a % b % c; PostImpl } \
  template<typename A, typename B> \
  inline rtype Symbol(const sChar * format, A a, B b) { PreImpl % a % b; PostImpl } \
  template<typename A> \
  inline rtype Symbol(const sChar * format, A a) { PreImpl % a; PostImpl } \
/*                                                                                                                   */ inline rtype Symbol(const sChar * format) { PreImpl % 0; PostImpl }

#define sPRINTING1(Symbol, PreImpl, PostImpl, ArgType1) \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I, typename J> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j) { PreImpl % a % b % c % d % e % f % g % h % i % j; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i) { PreImpl % a % b % c % d % e % f % g % h % i; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h) { PreImpl % a % b % c % d % e % f % g % h; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c, D d, E e, F f, G g) { PreImpl % a % b % c % d % e % f % g; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c, D d, E e, F f) { PreImpl % a % b % c % d % e % f; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c, D d, E e) { PreImpl % a % b % c % d % e; PostImpl } \
  template<typename A, typename B, typename C, typename D> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c, D d) { PreImpl % a % b % c % d; PostImpl } \
  template<typename A, typename B, typename C> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b, C c) { PreImpl % a % b % c; PostImpl } \
  template<typename A, typename B> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a, B b) { PreImpl % a % b; PostImpl } \
  template<typename A> \
  inline void Symbol(ArgType1 arg1, const sChar * format, A a) { PreImpl % a; PostImpl } \
/*                                                                                                                   */ inline void Symbol(ArgType1 arg1, const sChar * format) { PreImpl % 0; PostImpl }

#define sPRINTING2(Symbol, PreImpl, PostImpl, ArgType1, ArgType2) \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I, typename J> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j) { PreImpl % a % b % c % d % e % f % g % h % i % j; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h, I i) { PreImpl % a % b % c % d % e % f % g % h % i; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c, D d, E e, F f, G g, H h) { PreImpl % a % b % c % d % e % f % g % h; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F, typename G> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c, D d, E e, F f, G g) { PreImpl % a % b % c % d % e % f % g; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E, typename F> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c, D d, E e, F f) { PreImpl % a % b % c % d % e % f; PostImpl } \
  template<typename A, typename B, typename C, typename D, typename E> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c, D d, E e) { PreImpl % a % b % c % d % e; PostImpl } \
  template<typename A, typename B, typename C, typename D> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c, D d) { PreImpl % a % b % c % d; PostImpl } \
  template<typename A, typename B, typename C> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b, C c) { PreImpl % a % b % c; PostImpl } \
  template<typename A, typename B> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a, B b) { PreImpl % a % b; PostImpl } \
  template<typename A> \
  inline void Symbol(ArgType1 arg1, ArgType2 arg2, const sChar * format, A a) { PreImpl % a; PostImpl } \
...
public:
  ...
  {
    if(s)
      sCopyString(Buffer, s, size);
    else
      Buffer[0] = 0;
  }

  sString(const sChar* s, sInt len)
  {
    if(s)
      sCopyString(Buffer, s, sMin(size, len));
    else
      Buffer[0] = 0;
  }
  ...
  {
    sCopyString(Buffer, s.Buffer, size);
  }

  template<int n>
  sString(const sString<n>& s)
  {
    sCopyString(Buffer, s, size);
  }

  sString(const sPoolString& s);
  sString & operator = (const sChar* s)
  {
    if(s)
      sCopyString(Buffer, s, size);
    else
  ...
  template<int n>
  sString & operator = (const sString<n>& s)
  {
    if(s)
      sCopyString(Buffer, s, size);
    else
  ...
  operator sStringDesc ()
  {
    return sStringDesc(Buffer, size);
  }
  sBool operator == (const sChar* s) const
  {
    return sCmpString(Buffer, s) == 0;
  }

  sBool operator == (const sString& s) const
  {
    return sCmpString(Buffer, s.Buffer) == 0;
  }
  ...
  sBool operator < (const sPoolString& s) const;
  const sChar & operator [] (sInt i) const
  {
    return Buffer[i];
  }

  sChar & operator [] (sInt i)
  {
    return Buffer[i];
  }
  ...
  void Init(const sChar* a)
  {
    sInt n = sMin(size - 1, sGetStringLen(a));
    sCopyMem(Buffer, a, n * sizeof(sChar));
    Buffer[n] = 0;
  }

  void Init(const sChar* a, sInt len)
  {
    sInt n = sMin(size - 1, len);
    sCopyMem(Buffer, a, n * sizeof(sChar));
    Buffer[n] = 0;
  }

  sString & operator += (const sChar* a)
  {
    sAppendString(Buffer, a, size);
    return *this;
  }

  void Add(const sChar* a)
  {
    sAppendString(Buffer, a, size);
  }

  void Add(const sChar* a, sInt len)
  {
    sAppendString2(Buffer, a, size, len);
  }

  void Add(const sChar* a, const sChar* b)
  {
    sAppendString(Buffer, a, b, size);
  }
  ...
  void AddPath(const sChar* a)
  {
    sAppendPath(Buffer, a, size);
  }

  void PadRight(sInt length, sChar c = L' ')
  {
    sInt l = Count();

    while(l < sMin(length, size))
      Buffer[l++] = c;

    Buffer[l] = 0;
  };
  void PadLeft(sInt length, sChar c = L' ')
  {
    sInt l = sMin(length, size);
  ...
  void StripRight(const sChar* chars = L" \n\t")
  {
    ...
    while(l && sFindFirstChar(chars, Buffer[l - 1]) >= 0)
    {
      Buffer[l - 1] = 0;
      l--;
    }
  ...
  void StripLeft(const sChar* chars = L" \n\t")
  {
    ...
    while(sFindFirstChar(chars, Buffer[s]) >= 0)
      s++;
  ...
  void CutLeft(sInt length)
  {
    CutRange(0, length);
  }

  void CutRight(sInt length)
  {
    if(length > 0)
      Buffer[sMax(0, Count() - length)] = 0;
  }

  void CutRange(sInt start, sInt length)
  {
    sInt end = start + length;

    if(end < start)
      sSwap(end, start);

    sInt l = Count();
    sInt i = sClamp(start, 0, l);
    sInt n = sClamp(end, 0, l);
  ...
  sPRINTING0(PrintF, sFormatStringBuffer buf = sFormatStringBase(sStringDesc(Buffer, size), format);
             buf,;
             );
  sPRINTING0(PrintAddF, sFormatStringBuffer buf = sFormatStringBase(sStringDesc(Buffer + sGetStringLen(Buffer), size - sGetStringLen(Buffer)), format);
             buf,;
             );
};
...
sPRINTING1(sSPrintF, sFormatStringBuffer buf = sFormatStringBase(arg1, format);
           buf,;
           , const sStringDesc &)

sPRINTING0(sPrintF, sFormatStringBuffer buf;
           sFormatStringBaseCtx(buf, format);
           buf, sPrint(buf.Get());
           )
sPRINTING0(sPrintErrorF, sFormatStringBuffer buf;
           sFormatStringBaseCtx(buf, format);
           buf, sPrintError(buf.Get());
           )
sPRINTING0(sPrintWarningF, sFormatStringBuffer buf;
           sFormatStringBaseCtx(buf, format);
           buf, sPrintWarning(buf.Get());
           )
...
sPRINTING0(sDPrintF, sFormatStringBuffer buf;
           sFormatStringBaseCtx(buf, format);
           buf, sDPrint(buf.Get());
           )
#else
...
sPRINTING0(sPrintScreenF, sFormatStringBuffer buf;

           if(format)
             sFormatStringBaseCtx(buf, format);

           if(format)
             buf, sPrintScreen(format ? buf.Get() : 0);
...
sPRINTING1(sLogF, sFormatStringBuffer buf;
           sFormatStringBaseCtx(buf, format);
           buf, sLog(arg1, buf.Get());
           , const sChar*)
#else
...
template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I, typename J>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c, D d, E e, F f, G g, H h, I i, J j)
{
}

template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c, D d, E e, F f, G g, H h, I i)
{
}

template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c, D d, E e, F f, G g, H h)
{
}

template<typename A, typename B, typename C, typename D, typename E, typename F, typename G>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c, D d, E e, F f, G g)
{
}

template<typename A, typename B, typename C, typename D, typename E, typename F>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c, D d, E e, F f)
{
}

template<typename A, typename B, typename C, typename D, typename E>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c, D d, E e)
{
}

template<typename A, typename B, typename C, typename D>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c, D d)
{
}

template<typename A, typename B, typename C>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b, C c)
{
}

template<typename A, typename B>
inline void sLogF(const sChar* arg1, const sChar* format, A a, B b)
{
}

template<typename A>
inline void sLogF(const sChar* arg1, const sChar* format, A a)
{
}
...
sPRINTING0(sFatal, sFormatStringBuffer buf;
           sFormatStringBaseCtx(buf, format);
           buf, sFatalImpl(buf.Get());
           );
...
inline sBool sIsInfNan(sF32 x)
{
  return ((sF32U32(x) >> 23) & 0xff) == 0xff;
}

inline sBool sIsNan(sF32 x)
{
  return ((sF32U32(x) >> 23) & 0xff) == 0xff && (sF32U32(x) & 0x7fffff) != 0;
}

inline sBool sIsInf(sF32 x)
{
  return ((sF32U32(x) >> 23) & 0xff) == 0xff && (sF32U32(x) & 0x7fffff) == 0;
}
...
#else
sINLINE const sF32* sCheckFloatArray(const sF32*, sInt)
{
  return sNULL;
}
...
public:
  ...
  virtual sPtr MemSize(void*)
  {
    return 0;
  } // exact size of allocation

  virtual void Validate()
  {
  }      // check integrity of memory lists

  virtual sU32 MakeSnapshot()
  {
    return 0;
  }

  // statistics
  virtual sCONFIG_SIZET GetSize()
  {
    return End - Start;
  }

  virtual sCONFIG_SIZET GetFree()
  {
    return 0;
  }        // returns total free memory (or always 0 if not applicable)

  virtual sCONFIG_SIZET GetLargestFree()
  {
    return 0;
  } // returns largest possible allocation block (or always 0 if not applicable)

  sBool Contains(void* ptr)
  {
    return sPtr(ptr) >= Start && sPtr(ptr) < End;
  }
...
#define sINITMEM(f, s) struct sInitMem_ { sInitMem_(sInt flags, sPtr size) { sMemoryInitFlags = flags; sMemoryInitSize = size; } \
} sInitMem__(f, s);
#define sINITDEBUGMEM(s) struct sInitDebugMem_ { sInitDebugMem_(sPtr size) { sMemoryInitFlags |= sIMF_DEBUG; sMemoryInitDebugSize = size; } \
} sInitDebugMem__(s);
...
inline void sBeginAlt()
{
  sPushMemType(sAMF_HEAP | sAMF_ALT);
}

inline void sEndAlt()
{
  sPopMemType(sAMF_HEAP | sAMF_ALT);
}
...
{
  sF32 Probality;
  sScopeNoMemFailTest_()
  {
    Probality = sGetAllocFailTest();
    sSetAllocFailTest(0.0f);
  }

  ~sScopeNoMemFailTest_()
  {
    sSetAllocFailTest(Probality);
  }
};
...
#if sCONFIG_DEBUGMEM
inline void* sAllocMem_(sPtr size, sInt align, sInt flags, const char* file, sInt line)
{
  sTagMem(file, line);
  return sAllocMem_(size, align, flags);
}

inline void sCheckMem(const char* file, sInt line)
{
  sTagMem(file, line);
  sCheckMem_();
}
...
#if !sCONFIG_OPTION_XSI
#if sCONFIG_DEBUGMEM
inline void* sCDECL operator new (sCONFIG_SIZET size) throw()
{
  return sAllocMem_(size, 16, 0);
}
...
inline void* sCDECL operator new (sCONFIG_SIZET size, sInt flags) throw()
{
  return sAllocMem_(size, 16, flags);
}
...
inline void sCDECL operator delete (void* p) throw()
{
  sFreeMem(p);
}
...
inline void* sCDECL operator new (sCONFIG_SIZET size, const char* file, int line) throw()
{
  sTagMem(file, line);
  return sAllocMem_(size, 16, 0);
}
...
inline void* sCDECL operator new (sCONFIG_SIZET size, sInt flags, const char* file, int line) throw()
{
  sTagMem(file, line);
  return sAllocMem_(size, 16, flags);
}
...
inline void sCDECL operator delete (void* p, const char*, int) throw()
{
  sFreeMem(p);
}
...
inline void sCDECL operator delete (void* p)
{
  sFreeMem(p);
}
...
inline void* operator new (sCONFIG_SIZET, void* ptr) throw()
{
  return ptr;
}
...
template<class T>
T* sPlacementNew(void* ptr)
{
  return new (ptr)T;
}

template<class T, typename ARG0>
T* sPlacementNew(void* ptr, ARG0 arg0)
{
  return new (ptr)T(arg0);
}

template<class T, typename ARG0, typename ARG1>
T* sPlacementNew(void* ptr, ARG0 arg0, ARG1 arg1)
{
  return new (ptr)T(arg0, arg1);
}

template<class T, typename ARG0, typename ARG1, typename ARG2>
T* sPlacementNew(void* ptr, ARG0 arg0, ARG1 arg1, ARG2 arg2)
{
  return new (ptr)T(arg0, arg1, arg2);
}
...
template<typename T>
sINLINE T* sAllocFrameNew(sInt count = 1, sInt align = sALLOCFRAMEALIGN)
{
...
template<typename T>
sINLINE void sAllocFrameNew(T*& ptr, sInt count = 1, sInt align = sALLOCFRAMEALIGN)
{
...
template<typename T>
sINLINE T* sAllocFrameRaw(sInt count = 1, sInt align = sALLOCFRAMEALIGN)
{
  void* ptr = sAllocFrame(sizeof(T) * count, align);
  return (T*)ptr;
}
...
template<typename T>
sINLINE void sAllocFrameRaw(T*& ptr, sInt count = 1, sInt align = sALLOCFRAMEALIGN)
{
  ptr = sAllocFrameRaw<T>(count, align);
}

template<typename T>
sINLINE void sAllocFrameBegin(T*& ptr, sInt max, sInt align = sALLOCFRAMEALIGN)
{
...
struct sBaseRect
{
  ...
  sBaseRect(Type X0, Type Y0, Type X1, Type Y1)
  {
    x0 = X0;
    y0 = Y0;
    x1 = X1;
  ...
  sBaseRect(const sBaseRect& r)
  {
    *this = r;
  }

  template<typename T2>
  explicit sBaseRect(const sBaseRect<T2>& r)
  {
    x0 = Type(r.x0);
    y0 = Type(r.y0);
    x1 = Type(r.x1);
  ...
  void Init(Type X0, Type Y0, Type X1, Type Y1)
  {
    x0 = X0;
    y0 = Y0;
    x1 = X1;
  ...
  sBool IsInside(const sBaseRect& r) const
  {
  ...
  void Add(const sBaseRect& a, const sBaseRect& b)
  {
    if(b.IsEmpty())
    {
      *this = a;
  ...
  void And(const sBaseRect& a, const sBaseRect& b)
  {
    x0 = sMax(a.x0, b.x0);
    y0 = sMax(a.y0, b.y0);
    x1 = sMin(a.x1, b.x1);
  ...
  void ScaleCenter(sF32 x, sF32 y)
  {
    Type sx = SizeX() / 2;
    Type sy = SizeY() / 2;
    Type cx = CenterX();
  ...
  void ScaleCenter(sF32 s)
  {
    ScaleCenter(s, s);
  }

  void MoveCenter(Type cx, Type cy)
  {
    Type sx = SizeX() / 2;
    Type sy = SizeY() / 2;
    x0 = cx - sx;
  ...
  void SetSize(Type sx, Type sy)
  {
    x1 = x0 + sx;
    y1 = y0 + sy;
  }

  int operator != (const sBaseRect<Type>& r) const
  {
  ...
  sBaseRect<Type> & operator = (const sBaseRect<Type>& r)
  {
    x0 = r.x0;
    x1 = r.x1;
    y0 = r.y0;
  ...
  void Blend(const sBaseRect& l, const sBaseRect& r, sF32 n)
  {
    sF32 m = 1 - n;
    x0 = l.x0 * m + r.x0 * n;
    x1 = l.x1 * m + r.x1 * n;
  ...
  void Clip(const sBaseRect& c)
  {
    x0 = sClamp(x0, c.x0, c.x1);
    y0 = sClamp(y0, c.y0, c.y1);
    x1 = sClamp(x1, c.x0, c.x1);
    y1 = sClamp(y1, c.y0, c.y1);
  }

  void Div(Type x, Type y)
  {
    x0 /= x;
    y0 /= y;
    x1 /= x;
...
public:
  ...
  sU32 Int32();
  sF32 Float(sF32 max);
  inline sF32 FloatSigned(sF32 max)
  {
    return Float(2.0f * max) - max;
  }
};
...
public:
  ...
  sInt GetSlices() const
  {
    return Slices;
  }      // get number of slices for this frame

  sInt GetJitter() const
  {
    return Jitter;
  }      // get remaining milliseconds in next slice

  sInt GetTimeSlice() const
  {
    return TimeSlice;
  }

  sF32 GetAverageDelta() const;                   // averaged milliseconds of last 64 frames
  void SetHistoryMax(sInt m)
  {
    HistoryMax = sMin(m, (sInt)sCOUNTOF(History));
    HistoryCount = 0;
    HistoryIndex = 0;
  }
  ...
  sInt GetTimestampDelta(sInt time)
  {
...
template<typename T>
sINLINE void sChecksumAdler32Add(const T& data)
{
  sChecksumAdler32Add((const sU8*)&data, sizeof(T));
}
...
{
private:
  inline void f(sU32& a, sU32 b, sU32 c, sU32 d, sInt k, sInt s, sU32 t, sU32* data)
  {
    a += (d ^ (b & (c ^ d))) + data[k] + t;
    a = ((a << s) | (a >> (32 - s))) + b;
  }

  inline void g(sU32& a, sU32 b, sU32 c, sU32 d, sInt k, sInt s, sU32 t, sU32* data)
  {
    a += (c ^ (d & (b ^ c))) + data[k] + t;
    a = ((a << s) | (a >> (32 - s))) + b;
  }

  inline void h(sU32& a, sU32 b, sU32 c, sU32 d, sInt k, sInt s, sU32 t, sU32* data)
  {
    a += (b ^ c ^ d) + data[k] + t;
    a = ((a << s) | (a >> (32 - s))) + b;
  }

  inline void i(sU32& a, sU32 b, sU32 c, sU32 d, sInt k, sInt s, sU32 t, sU32* data)
  {
    a += (c ^ (b | ~d)) + data[k] + t;
    a = ((a << s) | (a >> (32 - s))) + b;
  }
...
public:
  ...
  sBool operator != (const sChecksumMD5& md5) const
  {
    return !(*this == md5);
  }
};
...
struct sInput2Event
{
  sInput2Event(sU32 key = 0, sInt instance = 0, sDInt payload = 0, sInt timestamp = sGetTime())
  {
    Key = key;
    Instance = instance;
    Payload = payload;
...
// virtual void OnKey(sU32 key);     // obsolete
  ...
  virtual void GetCaption(const sStringDesc& sd)
  {
    sCopyString(sd, L"sApp");
  }
};
...
struct sGUID
{
  ...
  {
    return !sCmpMem(this, &g, sizeof(sGUID));
  }

  bool operator != (const sGUID& g) const
  {
    return sCmpMem(this, &g, sizeof(sGUID)) != 0;
  }
...
static sINLINE sGUID sGetProjectGUID()
{
...
template<typename T>
struct sRemovePtrType
{
  typedef T Type;
};
template<typename T>
struct sRemovePtrType<T*>
{
  typedef T Type;
};
template<typename T>
...
public:
  ...
  explicit sStaticArray(sInt max)
  {
    Data = 0;
    Used = 0;
    Alloc = 0;
  ...
  sStaticArray(Type* data, sInt max)
  {
    Data = data;
    Used = 0;
    Alloc = max;
  ...
  void Copy(const sStaticArray& a)
  {
    sTAG_CALLER();
    Resize(a.GetCount());
  ...
  // ! Create a copy of all elements.
  sStaticArray(const sStaticArray& a)
  {
    sTAG_CALLER();
    Data = 0;
    Used = 0;
  ...
  // ! Create a copy of all elements.
  sStaticArray & operator = (const sStaticArray& a)
  {
    sTAG_CALLER();
  ...
  sBool IsIndexValid(sInt p) const
  {
    return ((unsigned)p) < ((unsigned)Used);
  }
  ...
  void HintSize(sInt max)
  {
    ReAlloc(max);
  }

  void HintSize_(sInt max, const char* file, sInt line)
  {
    sTagMem(file, line);
    ReAlloc(max);
  }
...
// ! Add all elements from another array
  ...
  Type* AddManyInit(sInt count, const Type* prototype = sNULL)
  {
    Type* r = AddMany(count);
  ...
  Type* AddFull()
  {
    return AddMany(GetSize() - GetCount());
  }

  Type* AddFullInit(const Type* prototype = sNULL)
  {
    return AddManyInit(GetSize() - GetCount(), prototype);
  }
  ...
  template<class RandomClass>
  void Shuffle(RandomClass& rnd_gen)
  {
    if(Used == 0)
      return;

    for(sInt i = Used - 1; i > 0; i--)
      Swap(rnd_gen.Int(i + 1), i);
  }

  // Don't use IndexOf, use sFindIndex instead!
  sOBSOLETE sInt IndexOf(const Type& e)
  {
    for(sInt i = 0; i < GetCount(); i++)
      if(Data[i] == e)
        return i;
...
template<class Type, int Max_>
class sStackArray : public sStaticArray<Type>
{
protected:
...
public:
  // das ganze rumgescope ist für den PS3-compiler...
  typedef typename sRemovePtrType<Type>::Type ElementType;
  enum
  {
    SIZE = Max_
  ...
  sStackArray()
  {
    sStaticArray<Type>::Data = Storage;
    sStaticArray<Type>::Used = 0;
    sStaticArray<Type>::Alloc = Max_;
  }

  explicit sStackArray(sInt initcount)
  {
    sStaticArray<Type>::Data = Storage;
    sStaticArray<Type>::Used = 0;
    sStaticArray<Type>::Alloc = Max_;
    sStaticArray<Type>::AddMany(initcount);
  }

  sStackArray(const sStackArray<Type, Max_>& other)
  {
    sStaticArray<Type>::Data = Storage;
    sStaticArray<Type>::Used = 0;
    sStaticArray<Type>::Alloc = Max_;
...
class sDNode
{
  template<class Type, sDNode Type::* Offset>
  friend class sDList;
  template<class Type, sDNode Type::* Offset>
  friend class sDListRange;
  template<class Type>
  friend class sDList2;
  sDNode* Next;
  sDNode* Prev;
  void Reset()
  {
...
class sDList
{
  ...
  const sDNode* GetNode(const Type* e) const
  {
    return &(e->*Offset);
  } // { return (sDNode *)(((sU8*)e)+Offset); }

  const Type* GetType(const sDNode* n) const
  {
    return (const Type*)(((sU8*)n) - sOFFSETOMP((Type*)0, Offset));
  }

  sDNode* GetNode(Type* e)
  {
    return &(e->*Offset);
  } // (sDNode *)(((sU8*)e)+Offset); }

  Type* GetType(sDNode* n)
  {
    return (Type*)(((sU8*)n) - sOFFSETOMP((Type*)0, Offset));
  }
...
public:
  ...
  int GetCount() const
  {
    ...
    for(const Type* iter = GetHead(); !IsEnd(iter); iter = GetNext(iter), ++count)
    {
    }
  ...
  const Type* GetNext(const Type* e) const
  {
    return GetType(GetNode(e)->Next);
  } // { return (Type*) (((sU8*)(GetNode(e)->Next))-MO(Offset)); }

  // ! get prev element in list
  const Type* GetPrev(const Type* e) const
  {
    return GetType(GetNode(e)->Prev);
  } // { return (Type*) (((sU8*)(GetNode(e)->Prev))-MO(Offset)); }
  ...
  sBool IsFirst(const Type* e) const
  {
    return GetNode(e)->Prev->Prev == 0;
  }

  // ! check if last element in list
  sBool IsLast(const Type* e) const
  {
    return GetNode(e)->Next->Next == 0;
  }
  ...
  sBool IsEnd(const Type* e) const
  {
    return GetNode(e)->Next == 0;
  }
  ...
  sBool IsStart(const Type* e) const
  {
    return GetNode(e)->Prev == 0;
  }
  ...
  sInt GetIndex(Type* e) const
  {
    const Type* h = GetType(First.Next);

    for(sInt i = 0; !IsEnd(h); i++, h = GetNext(h))
      if(e == h)
        return i;
  ...
  void AddHead(Type* e)
  {
    GetNode(e)->Next = First.Next;
    GetNode(e)->Prev = &First;
    First.Next->Prev = GetNode(e);
    First.Next = GetNode(e);
  }

  // ! Insert at end of list.
  void AddTail(Type* e)
  {
    GetNode(e)->Prev = Last.Prev;
    GetNode(e)->Next = &Last;
    Last.Prev->Next = GetNode(e);
    Last.Prev = GetNode(e);
  }
  ...
  void Rem(Type* e)
  {
    GetNode(e)->Next->Prev = GetNode(e)->Prev;
    GetNode(e)->Prev->Next = GetNode(e)->Next;
    GetNode(e)->Reset();
  }
  ...
  void AddBefore(Type* e, Type* ref)
  {
    GetNode(e)->Prev = GetNode(ref)->Prev;
    GetNode(e)->Next = GetNode(ref);
    GetNode(ref)->Prev->Next = GetNode(e);
    GetNode(ref)->Prev = GetNode(e);
  }

  // ! Add element after reference element.
  void AddAfter(Type* e, Type* ref)
  {
    GetNode(e)->Next = GetNode(ref)->Next;
    GetNode(e)->Prev = GetNode(ref);
    GetNode(ref)->Next->Prev = GetNode(e);
    GetNode(ref)->Next = GetNode(e);
  }
...
template<class Type, sDNode Type::* Offset>
sINLINE void sDeleteAll(sDList<Type, Offset>& list)
{
  while(!list.IsEmpty())
    delete list.RemHead();
}
...
class sDList2
{
  ...
  const Type* GetType(const sDNode* n) const
  {
    return (const Type*)(((sU8*)n) - sOFFSETOMP((Type*)0, &Type::Node));
  }
  ...
  Type* GetType(sDNode* n)
  {
    return (Type*)(((sU8*)n) - sOFFSETOMP((Type*)0, &Type::Node));
  }
...
// ! Delete all elements of a list
template<class Type>
sINLINE void sDeleteAll(sDList2<Type>& list)
{
  while(!list.IsEmpty())
    delete list.RemHead();
}
...
public:
  ...
  explicit sBlob(sInt bytes)
  {
    Ptr = 0;
    Create(bytes);
  }

  sBlob(const sBlob& blob)
  {
    Ptr = blob.Ptr;
    AddRef();
  }
  ...
  // c++ stuff
  sBlob & operator = (const sBlob& blob)
  {
    sU32* oldPtr = Ptr;
    Ptr = blob.Ptr;
    AddRef();
  ...
  // creation/deletion
  void Create(sInt bytes)
  {
    Release();
    Ptr = new sU32[(bytes + sizeof(sU32) - 1) / sizeof(sU32) + 2];
    Ptr[0] = bytes;
    Ptr[1] = 1;
  }
...
public:
  ...
  T* Alloc(sInt n = 1)
  {
    return (T*)Alloc(sizeof(T) * n, sALIGNOF(T));
  }
};
...
public:
  void Add(hfp hook, void* user = 0)
  {
    _Add((void*)hook, user);
  }

  void Rem(hfp hook, void* user = 0)
  {
    _Rem((void*)hook, user);
  }
  ...
  void Call()
  {
    ...
    {
      HookInfo* h;
      sFORALL(*Hooks, h) (*hfp(h->Hook))(h->User);
    }
  }
};
...
public:
  ...
  void Call(A a)
  {
    ...
    {
      HookInfo* h;
      sFORALL(*Hooks, h) (*hfp(h->Hook))(a, h->User);
    }
  }
};
template<typename A, typename B>
...
public:
  ...
  void Call(A a, B b)
  {
    ...
    {
      HookInfo* h;
      sFORALL(*Hooks, h) (*hfp(h->Hook))(a, b, h->User);
    }
  }
};
...
struct sMemLeakDescScope
{
  ...
  {
    sPushMemLeakDesc(str);
  }

  inline ~sMemLeakDescScope()
  {
    sPopMemLeakDesc();
  }
};
...
sINLINE sInt sAbs(sInt i)
{
  return abs(i);
}

sINLINE void sSetMem(void* dd, sInt s, sInt c)
{
  memset(dd, s, c);
}

sINLINE void sCopyMem(void* dd, const void* ss, sInt c)
{
  memcpy(dd, ss, c);
}

sINLINE sInt sCmpMem(const void* dd, const void* ss, sInt c)
{
  return (sInt)memcmp(dd, ss, c);
}

sINLINE sInt sMulDiv(sInt a, sInt b, sInt c)
{
  return sInt(__emul(a, b) / c);
}

sINLINE sU32 sMulDivU(sU32 a, sU32 b, sU32 c)
{
  return sU32(__emulu(a, b) / c);
}

sINLINE sInt sMulShift(sInt a, sInt b)
{
  return sInt(__emul(a, b) >> 16);
}

sINLINE sU32 sMulShiftU(sU32 a, sU32 b)
{
  return sU32(__emulu(a, b) >> 16);
}

sINLINE sInt sDivShift(sInt a, sInt b)
{
  return sInt((sS64(a) << 16) / b);
}

sINLINE sF32 sAbs(sF32 f)
{
  return fabs(f);
}
...
sINLINE sF32 sATan(sF32 f)
{
  return (sF32)atan(f);
}

sINLINE sF32 sATan2(sF32 over, sF32 under)
{
  return (sF32)atan2(over, under);
}

sINLINE sF32 sCos(sF32 f)
{
  return (sF32)cos(f);
}

sINLINE sF32 sExp(sF32 f)
{
  return (sF32)exp(f);
}

sINLINE sF32 sLog(sF32 f)
{
  return (sF32)log(f);
}

sINLINE sF32 sLog10(sF32 f)
{
  return (sF32)log10(f);
}

sINLINE sF32 sSin(sF32 f)
{
  return (sF32)sin(f);
}

sINLINE sF32 sSqrt(sF32 f)
{
  return (sF32)sqrtf(f);
}

sINLINE sF32 sRSqrt(sF32 f)
{
  return 1.0f / (sF32)sqrt(f);
}

sINLINE sF32 sTan(sF32 f)
{
  return (sF32)tan(f);
}

sINLINE sF32 sFATan(sF32 f)
{
  return (sF32)atan(f);
}

sINLINE sF32 sFATan2(sF32 over, sF32 under)
{
  return (sF32)atan2(over, under);
}

sINLINE sF32 sFCos(sF32 f)
{
  return (sF32)cos(f);
}

sINLINE sF32 sFExp(sF32 f)
{
  return (sF32)exp(f);
}

sINLINE sF32 sFLog(sF32 f)
{
  return (sF32)log(f);
}

sINLINE sF32 sFLog10(sF32 f)
{
  return (sF32)log10(f);
}

sINLINE sF32 sFSin(sF32 f)
{
  return (sF32)sin(f);
}

sINLINE sF32 sFTan(sF32 f)
{
  return (sF32)tan(f);
}
...
sINLINE sF32 sFSqrt(sF32 f)
{
  return (sF32)sqrtf(f);
}

sINLINE sF32 sFRSqrt(sF32 f)
{
  return 1.0f / (sF32)sqrt(f);
}
...
sINLINE void sSetMem(void* dd, sInt s, sInt c)
{
  __builtin_memset(dd, s, c);
}

sINLINE void sCopyMem(void* dd, const void* ss, sInt c)
{
  __builtin_memcpy(dd, ss, c);
}

sINLINE sInt sCmpMem(const void* aa, const void* bb, sInt c)
{
  return __builtin_memcmp(aa, bb, c);
}
...
sINLINE sF32 sLog(sF32 x)
{
  return __builtin_logf(x);
}

sINLINE sF32 sExp(sF32 x)
{
  return __builtin_expf(x);
}

sINLINE sF32 sFLog(sF32 x)
{
  return __builtin_logf(x);
}

sINLINE sF32 sFExp(sF32 x)
{
  return __builtin_expf(x);
}
...
public:
  ...
  sPRINTING0(PrintF, sFormatStringBuffer buf = sFormatStringBase(GetPrintBuffer(), format);
             buf, Print();
             );
};
...
public:
  ...
  const sStringDesc GetPrintBuffer()
  {
    return TextBuffer;
  }
  ...
  void Print()
  {
    sAppendString(StringDescriptor, TextBuffer);
    TextBuffer.Clear();
  }
