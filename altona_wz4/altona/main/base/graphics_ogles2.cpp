...
// assert(stream==0)
    ...
    case sVF_F2:  b[stream] += 2 * 4;
      ...
      Attr[i].Normalized = 0;
      break;
    case sVF_F3:  b[stream] += 3 * 4;
      Attr[i].Size = 3;
      Attr[i].Type = GL_FLOAT;
      Attr[i].Normalized = 0;
      break;
    case sVF_F4:  b[stream] += 4 * 4;
      Attr[i].Size = 4;
      Attr[i].Type = GL_FLOAT;
      Attr[i].Normalized = 0;
      break;
    case sVF_I4:  b[stream] += 1 * 4;
      Attr[i].Size = 4;
      Attr[i].Type = GL_UNSIGNED_BYTE;
      Attr[i].Normalized = 0;
      break;
    case sVF_C4:  b[stream] += 1 * 4;
      Attr[i].Size = 4;
      Attr[i].Type = GL_UNSIGNED_BYTE;
      Attr[i].Normalized = 1;
      break;
    case sVF_S2:  b[stream] += 1 * 4;
      Attr[i].Size = 2;
      Attr[i].Type = GL_SHORT;
      Attr[i].Normalized = 1;
      break;
    case sVF_S4:  b[stream] += 2 * 4;
      Attr[i].Size = 4;
      Attr[i].Type = GL_SHORT;
      Attr[i].Normalized = 1;
      break;
    ...
    {
    case sVF_POSITION:   Attr[i].Name = "in_pos";
      break;
    case sVF_NORMAL:     Attr[i].Name = "in_norm";
      break;
    case sVF_TANGENT:    Attr[i].Name = "in_tang";
      break;
    case sVF_BONEINDEX:  Attr[i].Name = "in_boneindex";
      break;
    case sVF_BONEWEIGHT: Attr[i].Name = "in_boneweight";
      break;
    case sVF_BINORMAL:   Attr[i].Name = "in_binorm";
      break;
    case sVF_COLOR0:     Attr[i].Name = "in_col0";
      break;
    case sVF_COLOR1:     Attr[i].Name = "in_col1";
      break;
    case sVF_COLOR2:     Attr[i].Name = "in_col2";
      break;
    case sVF_COLOR3:     Attr[i].Name = "in_col3";
      break;
    case sVF_UV0:        Attr[i].Name = "in_uv0";
      break;
    case sVF_UV1:        Attr[i].Name = "in_uv1";
      break;
    case sVF_UV2:        Attr[i].Name = "in_uv2";
      break;
    case sVF_UV3:        Attr[i].Name = "in_uv3";
      break;
    case sVF_UV4:        Attr[i].Name = "in_uv4";
      break;
    case sVF_UV5:        Attr[i].Name = "in_uv5";
      break;
    case sVF_UV6:        Attr[i].Name = "in_uv6";
      break;
    case sVF_UV7:        Attr[i].Name = "in_uv7";
      break;
    default: sVERIFYFALSE;
    }
