    ...
    while(Data[i])
    {
      if(((Data[i] & sVF_STREAMMASK) >> sVF_STREAMSHIFT) == (sU32)stream)
      {
        ...
        case sVF_NOP:         decl[dindex].Index = -1;
          break;
        case sVF_POSITION:    decl[dindex].Index = 0;
          break;
        case sVF_NORMAL:      decl[dindex].Index = 2;
          break;
        case sVF_TANGENT:     decl[dindex].Index = 6;
          break;
        case sVF_BONEINDEX:   decl[dindex].Index = 7;
          break;
        case sVF_BONEWEIGHT:  decl[dindex].Index = 1;
          break;
        case sVF_COLOR0:      decl[dindex].Index = 3;
          break;
        case sVF_COLOR1:      decl[dindex].Index = 4;
          break;
        case sVF_UV0:         decl[dindex].Index = 8;
          break;
        case sVF_UV1:         decl[dindex].Index = 9;
          break;
        case sVF_UV2:         decl[dindex].Index = 10;
          break;
        case sVF_UV3:         decl[dindex].Index = 11;
          break;
        case sVF_UV4:         decl[dindex].Index = 12;
          break;
        case sVF_UV5:         decl[dindex].Index = 13;
          break;
        case sVF_UV6:         decl[dindex].Index = 14;
          break;
        case sVF_UV7:         decl[dindex].Index = 15;
          break;
        ...
        {
        case sVF_F2:  decl[dindex].Type = GL_FLOAT;
          decl[dindex].Size = 2;
          decl[dindex].Normalized = 0;
          bytes = 2 * 4;
          break;
        case sVF_F3:  decl[dindex].Type = GL_FLOAT;
          decl[dindex].Size = 3;
          decl[dindex].Normalized = 0;
          bytes = 3 * 4;
          break;
        case sVF_F4:  decl[dindex].Type = GL_FLOAT;
          decl[dindex].Size = 4;
          decl[dindex].Normalized = 0;
          bytes = 4 * 4;
          break;
        case sVF_I4:  decl[dindex].Type = GL_UNSIGNED_BYTE;
          decl[dindex].Size = 4;
          decl[dindex].Normalized = 0;
          bytes = 1 * 4;
          break;
        case sVF_C4:  decl[dindex].Type = GL_UNSIGNED_BYTE;
          decl[dindex].Size = 4;
          decl[dindex].Normalized = 1;
          bytes = 1 * 4;
          break;
        case sVF_S2:  decl[dindex].Type = GL_UNSIGNED_SHORT;
          decl[dindex].Size = 2;
          decl[dindex].Normalized = 1;
          bytes = 1 * 4;
          break;
        case sVF_S4:  decl[dindex].Type = GL_UNSIGNED_SHORT;
          decl[dindex].Size = 4;
          decl[dindex].Normalized = 1;
          bytes = 2 * 4;
          break;
        case sVF_H2:  decl[dindex].Type = GL_HALF_FLOAT_NV;
          decl[dindex].Size = 2;
          decl[dindex].Normalized = 0;
          bytes = 1 * 4;
          break;
        case sVF_H4:  decl[dindex].Type = GL_HALF_FLOAT_NV;
          decl[dindex].Size = 4;
          decl[dindex].Normalized = 0;
          bytes = 2 * 4;
          break;
        case sVF_F1:  decl[dindex].Type = GL_FLOAT;
          decl[dindex].Size = 1;
          decl[dindex].Normalized = 0;
          bytes = 1 * 4;
          break;
...
void sSetRendertarget(const sRect* vrp, sTexture2D* tex, sInt clearflags, sU32 clearcolor)
{
  ...
  if(clearflags & sCLEAR_COLOR)
    mode |= GL_COLOR_BUFFER_BIT;

  if(clearflags & sCLEAR_ZBUFFER)
