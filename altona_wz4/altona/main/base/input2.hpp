...
enum sInput2Keyboard
{
  sINPUT2_KEYBOARD_ESCAPE = 1, sINPUT2_KEYBOARD_1 = 2, sINPUT2_KEYBOARD_2, sINPUT2_KEYBOARD_3, sINPUT2_KEYBOARD_4, sINPUT2_KEYBOARD_5, sINPUT2_KEYBOARD_6, sINPUT2_KEYBOARD_7, sINPUT2_KEYBOARD_8, sINPUT2_KEYBOARD_9, sINPUT2_KEYBOARD_0,
...
public:
  ...
  sBool IsStatus(sInput2Status condition) const
  {
    return (GetStatusWord() & condition) != 0;
  }
  ...
  void SetMotor(sInt slow, sInt fast)
  {
    MotorSlow = slow;
    MotorFast = fast;
  } // ! set motor of the device. this should REALLY be replaced by something more intelligent and is not really part of an input system.
...
public:
  ...
  sU32 GetStatusWord() const
  {
    return Status;
  }

  sInt GetTimestamp() const
  {
    return Timestamp;
  }
...
template<sInt NUM>
class sInput2CustomEvaluator : public sInput2DeviceImpl<NUM>
{
public:
...
public:
  sInput2Key()
  {
    Device = sNULL;
    KeyId = 0;
    ThresholdAnalog = 0.0f;
    ThresholdDigitalLo = 0.5f;
    ThresholdDigitalHi = 0.8f;
    Next = sNULL;
  }

  sInput2Key(const sInput2Key& other)
  {
    Device = other.Device;
    KeyId = other.KeyId;
    ThresholdAnalog = other.ThresholdAnalog;
    ThresholdDigitalHi = other.ThresholdDigitalHi;
    ThresholdDigitalLo = other.ThresholdDigitalLo;
    Next = 0;
  }
  ...
  sBool operator == (const sInput2Key& other) const
  {
    return Device == other.Device && KeyId == other.KeyId && ThresholdAnalog == other.ThresholdAnalog && ThresholdDigitalLo == other.ThresholdDigitalLo && ThresholdDigitalHi == other.ThresholdDigitalHi;
  }
