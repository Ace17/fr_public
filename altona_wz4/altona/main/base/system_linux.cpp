...
static void sXMessageLoop()
{
  ...
  {
    sBool done = sFALSE;
    static const sInt buttonKey[10] =
    {
      0, sKEY_LMB, sKEY_MMB, sKEY_RMB, sKEY_WHEELUP, sKEY_WHEELDOWN, 0, 0, sKEY_X1MB, sKEY_X2MB
    };
    static const sInt buttonMask[10] =
    {
      0, sMouseData::sMB_LEFT, sMouseData::sMB_MIDDLE, sMouseData::sMB_RIGHT, 0, 0, 0, 0, sMouseData::sMB_X1, sMouseData::sMB_X2
    };
        ...
        case KeyRelease:
          {
            ...
            switch(sym)
            {
            case XK_Shift_L:    sKeyQual = (sKeyQual & ~sKEYQ_SHIFTL) | (sKEYQ_SHIFTL & orm);
              break;
            case XK_Shift_R:    sKeyQual = (sKeyQual & ~sKEYQ_SHIFTR) | (sKEYQ_SHIFTR & orm);
              break;
            case XK_Control_L:  sKeyQual = (sKeyQual & ~sKEYQ_CTRLL) | (sKEYQ_CTRLL & orm);
              break;
            case XK_Control_R:  sKeyQual = (sKeyQual & ~sKEYQ_CTRLR) | (sKEYQ_CTRLR & orm);
              break;
            case XK_Alt_L:      sKeyQual = (sKeyQual & ~sKEYQ_ALT) | (sKEYQ_ALT & orm);
              break;
            case XK_Alt_R:      sKeyQual = (sKeyQual & ~sKEYQ_ALTGR) | (sKEYQ_ALTGR & orm);
              break;
            case XK_Delete:     wch[0] = 0;
