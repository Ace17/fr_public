...
sU64 CurrentCBsMask[sCBUFFER_SHADERTYPES] =
{
  0
};
#endif
...
sU32 DeclBasic[] =
{
  sVF_POSITION, sVF_COLOR0, 0
};
sU32 DeclStandard[] =
{
  sVF_POSITION, sVF_NORMAL, sVF_UV0, 0
};
sU32 DeclSingle[] =
{
  sVF_POSITION, sVF_COLOR0, sVF_UV0, 0
};
sU32 DeclDouble[] =
{
  sVF_POSITION, sVF_COLOR0, sVF_UV0, sVF_UV1, 0
};
sU32 DeclTangent[] =
{
  sVF_POSITION, sVF_NORMAL, sVF_TANGENT | sVF_F3, sVF_UV0, 0
};
sU32 DeclTSpace[] =
{
  sVF_POSITION, sVF_NORMAL, sVF_TANGENT | sVF_F3, sVF_COLOR0, sVF_UV0, sVF_UV1, 0
};
sU32 DeclTSpace4[] =
{
  sVF_POSITION, sVF_NORMAL, sVF_TANGENT | sVF_F4, sVF_COLOR0, sVF_UV0, sVF_UV1, 0
};
sU32 DeclTSpace4_uv3[] =
{
  sVF_POSITION, sVF_NORMAL, sVF_TANGENT | sVF_F4, sVF_COLOR0, sVF_UV0, sVF_UV1, sVF_UV2, 0
};
sU32 DeclTSpace4Anim[] =
{
  sVF_POSITION, sVF_NORMAL, sVF_TANGENT | sVF_F4, sVF_BONEINDEX | sVF_I4, sVF_BONEWEIGHT | sVF_C4, sVF_COLOR0, sVF_UV0, sVF_UV1, 0
};
sU32 DeclInstance[] =
{
  sVF_STREAM1 | sVF_UV5 | sVF_F4 | sVF_INSTANCEDATA, sVF_STREAM1 | sVF_UV6 | sVF_F4 | sVF_INSTANCEDATA, sVF_STREAM1 | sVF_UV7 | sVF_F4 | sVF_INSTANCEDATA, 0
};
sU32 DeclInstancePlus[] =
{
  sVF_STREAM1 | sVF_UV5 | sVF_F4 | sVF_INSTANCEDATA, sVF_STREAM1 | sVF_UV6 | sVF_F4 | sVF_INSTANCEDATA, sVF_STREAM1 | sVF_UV7 | sVF_F4 | sVF_INSTANCEDATA, sVF_STREAM1 | sVF_UV4 | sVF_F4 | sVF_INSTANCEDATA, 0
};
...
sInt sVertexFormatHandle::GetOffset(sInt semantic_and_format)
{
  ...
  while(data[i])
  {
    ...
    {
    case sVF_F2:  offset += 2 * 4;
      break;
    case sVF_F3:  offset += 3 * 4;
      break;
    case sVF_F4:  offset += 4 * 4;
      break;
    case sVF_I4:  offset += 1 * 4;
      break;
    case sVF_C4:  offset += 1 * 4;
      break;
    case sVF_S2:  offset += 1 * 4;
      break;
    case sVF_S4:  offset += 2 * 4;
      break;
    case sVF_H2:  offset += 2 * 2;
      break;
    case sVF_H3:  offset += 3 * 2;
      break;
    case sVF_H4:  offset += 4 * 2;
      break;
    case sVF_F1:  offset += 1 * 4;
      break;
...
void sGeometry::Init(sInt flags, sVertexFormatHandle* form)
{
  ...
  {
  case sGF_INDEX16:  IndexSize = 2;
    break;
  case sGF_INDEX32:  IndexSize = 4;
    break;
  default: IndexSize = 0;
  }
}
...
sInt sGetBitsPerPixel(sInt format)
{
  ...
  {
  case sTEX_ARGB8888: BitsPerPixel = 32;
    break;
  case sTEX_QWVU8888: BitsPerPixel = 32;
    break;

  case sTEX_GR16:     BitsPerPixel = 32;
    break;
  case sTEX_ARGB16:   BitsPerPixel = 64;
    break;

  case sTEX_R32F:     BitsPerPixel = 32;
    break;
  case sTEX_GR32F:    BitsPerPixel = 64;
    break;
  case sTEX_ARGB32F:  BitsPerPixel = 128;
    break;
  case sTEX_R16F:     BitsPerPixel = 16;
    break;
  case sTEX_GR16F:    BitsPerPixel = 32;
    break;
  case sTEX_ARGB16F:  BitsPerPixel = 64;
    break;

  case sTEX_A8:       BitsPerPixel = 8;
    break;
  case sTEX_I8:       BitsPerPixel = 8;
    break;
  case sTEX_DXT1:     BitsPerPixel = 4;
    break;
  case sTEX_DXT1A:    BitsPerPixel = 4;
    break;
  case sTEX_DXT3:     BitsPerPixel = 8;
    break;
  case sTEX_DXT5:     BitsPerPixel = 8;
    break;
  case sTEX_DXT5N:    BitsPerPixel = 8;
    break;

  case sTEX_MRGB8:    BitsPerPixel = 32;
    break;
  case sTEX_MRGB16:   BitsPerPixel = 64;
    break;

  case sTEX_ARGB2101010: BitsPerPixel = 32;
    break;
  case sTEX_D24S8:    BitsPerPixel = 32;
    break;

// case sTEX_A4:       BitsPerPixel =  4; break;
  case sTEX_I4:       BitsPerPixel = 4;
    break;
  case sTEX_IA4:      BitsPerPixel = 8;
    break;
  case sTEX_IA8:      BitsPerPixel = 16;
    break;
  case sTEX_RGB5A3:   BitsPerPixel = 16;
    break;

  case sTEX_INDEX4:   BitsPerPixel = 4;
    break;
  case sTEX_INDEX8:   BitsPerPixel = 8;
    break;

  case sTEX_ARGB1555: BitsPerPixel = 16;
    break;
  case sTEX_ARGB4444: BitsPerPixel = 16;
    break;
  case sTEX_RGB565:   BitsPerPixel = 16;
    break;
  case sTEX_GR8:      BitsPerPixel = 16;
    break;

  case sTEX_DEPTH16NOREAD:  BitsPerPixel = 16;
    break;
  case sTEX_DEPTH24NOREAD:  BitsPerPixel = 32;
    break;
  case sTEX_PCF16:    BitsPerPixel = 16;
    break;
  case sTEX_PCF24:    BitsPerPixel = 32;
    break;
  case sTEX_DEPTH16:  BitsPerPixel = 16;
    break;
  case sTEX_DEPTH24:  BitsPerPixel = 32;
    break;

  case sTEX_DXT5_AYCOCG: BitsPerPixel = 8;
    break;

  case sTEX_8TOIA:       BitsPerPixel = 8;
    break;

  case sTEX_UINT32:   BitsPerPixel = 32;
    break;
...
template<class streamer>
static inline void SerializeMaterialRS(sMaterialRS& rs, streamer& s)
{
  sInt version = 2;
...
void sMaterialRS::SerializeOld(sReader& s)
{
  SerializeMaterialRSOld(*this, s);
}

void sMaterialRS::SerializeOld(sWriter& s)
{
  SerializeMaterialRSOld(*this, s);
}

void sMaterialRS::Serialize(sReader& s)
{
  SerializeMaterialRS(*this, s);
}

void sMaterialRS::Serialize(sWriter& s)
{
  SerializeMaterialRS(*this, s);
}
...
sInt sViewport::Visible(const sAABBox& box, sF32 clipnear, sF32 clipfar) const
{
  ...
  sVector30 r[2][3];
  r[0][0].x = (mv.i.x * box.Min.x + mv.l.x) * zx;
  r[0][0].y = (mv.i.y * box.Min.x) * zy;
  r[0][0].z = mv.i.z * box.Min.x;
  r[0][1].x = (mv.j.x * box.Min.y) * zx;
  r[0][1].y = (mv.j.y * box.Min.y + mv.l.y) * zy;
  r[0][1].z = mv.j.z * box.Min.y;
  r[0][2].x = (mv.k.x * box.Min.z) * zx;
  r[0][2].y = (mv.k.y * box.Min.z) * zy;
  r[0][2].z = mv.k.z * box.Min.z + mv.l.z;
  r[1][0].x = (mv.i.x * box.Max.x + mv.l.x) * zx;
  r[1][0].y = (mv.i.y * box.Max.x) * zy;
  r[1][0].z = mv.i.z * box.Max.x;
  r[1][1].x = (mv.j.x * box.Max.y) * zx;
  r[1][1].y = (mv.j.y * box.Max.y + mv.l.y) * zy;
  r[1][1].z = mv.j.z * box.Max.y;
  r[1][2].x = (mv.k.x * box.Max.z) * zx;
  r[1][2].y = (mv.k.y * box.Max.z) * zy;
  r[1][2].z = mv.k.z * box.Max.z + mv.l.z;
...
sInt sViewport::VisibleDist(const sAABBox& box, sF32& dist) const
{
  ...
  r[1] = ModelView;
  r[0].i *= box.Min.x;
  r[0].i.x += ModelView.l.x;
  r[0].j *= box.Min.y;
  r[0].j.y += ModelView.l.y;
  r[0].k *= box.Min.z;
  r[0].k.z += ModelView.l.z;
  r[1].i *= box.Max.x;
  r[1].i.x += ModelView.l.x;
  r[1].j *= box.Max.y;
  r[1].j.y += ModelView.l.y;
  r[1].k *= box.Max.z;
  r[1].k.z += ModelView.l.z;
...
sBool sViewport::Get2DBounds(const sVector31 points[], sInt count, sFRect& bounds) const
{
  ...
  for(sInt i = 0; i < count; i++)
  {
    ...
    if((out & 0x3) == 0)
    {
      if(p.x - xMin * p.w < 0.0f)
        xMin = p.x / p.w;

      if(p.x - xMax * p.w > 0.0f)
        xMax = p.x / p.w;
    }

    if((out & 0xc) == 0)
    {
      if(p.y - yMin * p.w < 0.0f)
        yMin = p.y / p.w;

      if(p.y - yMax * p.w > 0.0f)
        yMax = p.y / p.w;
    }
  ...
  for(sInt i = 0; i < count; i++)
  {
    ...
    if((outcodes[i] & 1) && (p.x - xMin * p.w < 0.0f))
      xMin = -1.0f;

    if((outcodes[i] & 2) && (p.x - xMax * p.w > 0.0f))
      xMax = 1.0f;

    if((outcodes[i] & 4) && (p.y - yMin * p.w < 0.0f))
      yMin = -1.0f;

    if((outcodes[i] & 8) && (p.y - yMax * p.w > 0.0f))
      yMax = 1.0f;
  }
...
{
  static const sInt w1Tab[4] =
  {
    3, 0, 2, 1
  };
  static const sInt prods[4] =
  {
...
void sSetRendertarget(const sRect* vrp, sInt flags, sU32 clearcolor)
{
  ...
  if(flags & sCLEAR_COLOR)
    newflags |= sST_CLEARCOLOR;

  if(flags & sCLEAR_ZBUFFER)
    newflags |= sST_CLEARDEPTH;
...
sINLINE sTexture2D* sGetCurrentBackBuffer()
{
  return sGetScreenColorBuffer();
}

sINLINE sTexture2D* sGetCurrentBackZBuffer()
{
  return sGetScreenDepthBuffer();
}

sINLINE void sEnlargeRTDepthBuffer(sInt x, sInt y)
{
  sEnlargeZBufferRT(x, y);
}
...
void sSetTarget(const sTargetPara& para)
{
  ...
  if(para.Flags & sST_NOMSAA)
    oldflags |= sRTF_NO_MULTISAMPLING;

  if(!(para.Flags & sST_SCISSOR))
    oldflags |= sCLEAR_NOSCISSOR;
  ...
  else
  {
    ...
    {
      if(para.ClearColor[n] != para.ClearColor[0])
        differentCols = sTRUE;
...
sTexture2D* sGetScreenColorBuffer(sInt screeen)
{
  return sGetCurrentBackBuffer();
}

sTexture2D* sGetScreenDepthBuffer(sInt screeen)
{
  return sGetCurrentBackZBuffer();
}

sTexture2D* sGetRTDepthBuffer()
{
  static sTexture2D dummy;
  return &dummy;
}  // we need to return dummy texture to correctly handle no zbuffer case
