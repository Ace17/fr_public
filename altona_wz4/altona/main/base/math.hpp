...
public:
  ...
  sVector2(sF32 xx, sF32 yy)
  {
    x = xx;
    y = yy;
  }

  sVector2(const sFRect& rect)
  {
    x = rect.SizeX();
    y = rect.SizeY();
  }

  void Init(sF32 xx = 0, sF32 yy = 0)
  {
    x = xx;
    y = yy;
  }

  sVector2(const sVector2& a)
  {
    x = a.x;
    y = a.y;
  }

  sVector2 & operator = (sVector2Arg a)
  {
    x = a.x;
    y = a.y;
    return *this;
  ...
  void Average(sVector2Arg a, sVector2Arg b)
  {
    x = (a.x + b.x) * 0.5f;
    y = (a.y + b.y) * 0.5f;
  }

  void Fade(sF32 f, sVector2Arg a, sVector2Arg b)
  {
    x = a.x + (b.x - a.x) * f;
    y = a.y + (b.y - a.y) * f;
  }
  ...
  void UnitPrecise()
  {
    sF32 e = sRSqrt(x * x + y * y);
    x *= e;
    y *= e;
  }

  sOBSOLETE void UnitSlow()
  {
    sF32 e = sRSqrt(x * x + y * y);
    x *= e;
    y *= e;
  }   // UnitPrecise sounds better the UnitSlow

  void UnitFast()
  {
    sF32 e = sFRSqrt(x * x + y * y);
    x *= e;
    y *= e;
  }

  sF32 & operator [] (sInt i)
  {
    return (&x)[i];
  }

  const sF32 & operator [] (sInt i) const
  {
    return (&x)[i];
  }
  ...
  sF32 Length() const
  {
    return (sF32)sFSqrt(x * x + y * y);
  }

  sF32 LengthPrecise() const
  {
    return (sF32)sSqrt(x * x + y * y);
  }
  ...
  operator sFRect () const {
    return sFRect(x, y);
  }
  inline sBool operator == (sVector2Arg v) const
  {
    return x == v.x && y == v.y;
  }
...
public:
  ...
  explicit sVector31(sF32 xyz)
  {
    x = y = z = xyz;
  }

  sVector31(sF32 xx, sF32 yy, sF32 zz)
  {
    x = xx;
    y = yy;
    z = zz;
  ...
  void Init(sF32 xx, sF32 yy, sF32 zz)
  {
    x = xx;
    y = yy;
    z = zz;
  ...
  inline sVector31 & operator = (sVector31Arg a)
  {
    x = a.x;
    y = a.y;
    z = a.z;
  ...
  sU32 GetColor() const;
  inline void Fade(sF32 f, sVector31Arg a, sVector31Arg b)
  {
    x = a.x + (b.x - a.x) * f;
    y = a.y + (b.y - a.y) * f;
    z = a.z + (b.z - a.z) * f;
  ...
  inline void Average(sVector31Arg a, sVector31Arg b)
  {
    x = (a.x + b.x) * 0.5f;
    y = (a.y + b.y) * 0.5f;
    z = (a.z + b.z) * 0.5f;
  ...
  inline sF32 & operator [] (sInt i)
  {
    return (&x)[i];
  }

  inline const sF32 & operator [] (sInt i) const
  {
    return (&x)[i];
  }

  inline sBool operator == (sVector31Arg v) const
  {
...
public:
  ...
  explicit sVector30(sF32 xyz)
  {
    x = y = z = xyz;
  }

  sVector30(sF32 xx, sF32 yy, sF32 zz)
  {
    x = xx;
    y = yy;
    z = zz;
  ...
  sVector30 & operator = (sVector30Arg a)
  {
    x = a.x;
    y = a.y;
    z = a.z;
  ...
  explicit sVector30(const sVector31& a)
  {
    x = a.x;
    y = a.y;
    z = a.z;
  ...
  void InitColor(sU32 col, sF32 amp);
  sU32 GetColor() const;
  inline void Fade(sF32 f, sVector30Arg a, sVector30Arg b)
  {
    x = a.x + (b.x - a.x) * f;
    y = a.y + (b.y - a.y) * f;
    z = a.z + (b.z - a.z) * f;
  ...
  inline void Average(sVector30Arg a, sVector30Arg b)
  {
    x = (a.x + b.x) * 0.5f;
    y = (a.y + b.y) * 0.5f;
    z = (a.z + b.z) * 0.5f;
  ...
  inline sF32 Length() const
  {
    return (sF32)sFSqrt(x * x + y * y + z * z);
  }

  inline sF32 LengthPrecise() const
  {
    return (sF32)sSqrt(x * x + y * y + z * z);
  }

  inline sF32 LengthSq() const
  {
    return x * x + y * y + z * z;
  }
  ...
  sVector30 Cross(sVector30Arg v) const
  {
    return sVector30(y * v.z - z * v.y, z * v.x - x * v.z, x * v.y - y * v.x);
  }

  void Rotate(const sMatrix34& m, sVector30Arg v);

  void Unit();
  inline void UnitFast()
  {
    sF32 e = sFRSqrt(x * x + y * y + z * z);
    x *= e;
    y *= e;
    z *= e;
  }
  ...
  inline sVector30 GetUnit() const
  {
    sVector30 n = *this;
    n.Unit();
    return n;
  ...
  void Reciprocal(sVector30Arg a)
  {
    x = 1.0f / a.x;
    y = 1.0f / a.y;
    z = 1.0f / a.z;
  ...
  void ReciprocalKeepZero(sVector30Arg a)
  {
    x = a.x ? (1.0f / a.x) : 0.0f;
    y = a.y ? (1.0f / a.y) : 0.0f;
    z = a.z ? (1.0f / a.z) : 0.0f;
  ...
  inline sBool operator == (sVector30Arg v) const
  {
    return x == v.x && y == v.y && z == v.z;
  }
...
public:
  ...
  sVector4(sF32 xx, sF32 yy, sF32 zz, sF32 ww)
  {
    x = xx;
    y = yy;
    z = zz;
  ...
  void Init(sF32 xx, sF32 yy, sF32 zz, sF32 ww)
  {
    x = xx;
    y = yy;
    z = zz;
  ...
  sVector4 & operator = (sVector30Arg a)
  {
    x = a.x;
    y = a.y;
    z = a.z;
  ...
  sVector4 & operator = (sVector31Arg a)
  {
    x = a.x;
    y = a.y;
    z = a.z;
  ...
  sVector4 & operator = (sVector4Arg a)
  {
    x = a.x;
    y = a.y;
    z = a.z;
  ...
  void InitColor(sU32 col, sF32 amp);
  sU32 GetColor() const;
  inline void Average(sVector4Arg a, sVector4Arg b)
  {
    x = (a.x + b.x) * 0.5f;
    y = (a.y + b.y) * 0.5f;
    z = (a.z + b.z) * 0.5f;
  ...
  inline sBool operator != (sVector4Arg v) const
  {
    return x != v.x || y != v.y || z != v.z;
  }
};

inline sU32 sMakeColorRGBA(sF32* p)
{
  sVector4 c(p[0], p[1], p[2], p[3]);
  return c.GetColor();
}

inline sVector2 operator + (sVector2Arg a, sVector2Arg b)
{
  return sVector2(a.x + b.x, a.y + b.y);
}

inline sVector30 operator + (sVector30Arg a, sVector30Arg b)
{
  return sVector30(a.x + b.x, a.y + b.y, a.z + b.z);
}

inline sVector31 operator + (sVector31Arg a, sVector30Arg b)
{
  return sVector31(a.x + b.x, a.y + b.y, a.z + b.z);
}

inline sVector31 operator + (sVector30Arg a, sVector31Arg b)
{
  return sVector31(a.x + b.x, a.y + b.y, a.z + b.z);
}

inline sVector4 operator + (const sVector4& a, const sVector4& b)
{
  return sVector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
}
...
inline sVector30 operator - (sVector31Arg a, sVector31Arg b)
{
  return sVector30(a.x - b.x, a.y - b.y, a.z - b.z);
}
...
inline sVector2 operator - (sVector2Arg a)
{
  return sVector2(-a.x, -a.y);
}

inline sVector30 operator - (sVector30Arg a)
{
  return sVector30(-a.x, -a.y, -a.z);
}

inline sVector31 operator - (sVector31Arg a)
{
  return sVector31(-a.x, -a.y, -a.z);
}

inline sVector4 operator - (const sVector4& a)
{
  return sVector4(-a.x, -a.y, -a.z, -a.w);
}

inline sVector2 operator * (const sVector2& a, sF32 s)
{
  return sVector2(a.x * s, a.y * s);
}

inline sVector30 operator * (sVector30Arg a, sF32 s)
{
  return sVector30(a.x * s, a.y * s, a.z * s);
}

inline sVector4 operator * (const sVector4& a, sF32 s)
{
  return sVector4(a.x * s, a.y * s, a.z * s, a.w * s);
}

inline sVector2 operator * (sF32 s, sVector2Arg a)
{
  return sVector2(s * a.x, s * a.y);
}

inline sVector30 operator * (sF32 s, sVector30Arg a)
{
  return sVector30(a.x * s, a.y * s, a.z * s);
}

inline sVector4 operator * (sF32 s, const sVector4& a)
{
  return sVector4(a.x * s, a.y * s, a.z * s, a.w * s);
}
...
inline sVector30 operator * (sVector30Arg a, sVector31Arg b)
{
  return sVector30(a.x * b.x, a.y * b.y, a.z * b.z);
}

inline sVector30 operator * (sVector31Arg a, sVector30Arg b)
{
  return sVector30(a.x * b.x, a.y * b.y, a.z * b.z);
}

inline sVector31 operator * (sVector31Arg a, sVector31Arg b)
{
  return sVector31(a.x * b.x, a.y * b.y, a.z * b.z);
}
...
inline sVector2 operator / (sVector2Arg a, sF32 s)
{
  s = 1.0f / s;
  return sVector2(a.x * s, a.y * s);
}
...
inline sF32 operator ^ (sVector2Arg a, sVector2Arg b)
{
  return a.x * b.x + a.y * b.y;
}

inline sF32 operator ^ (sVector30Arg a, sVector30Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 operator ^ (sVector30Arg a, sVector31Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 operator ^ (sVector31Arg a, sVector30Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 operator ^ (sVector30Arg a, sVector4Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 operator ^ (sVector31Arg a, sVector4Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z + b.w;
}

inline sF32 operator ^ (sVector4Arg a, sVector30Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 operator ^ (sVector4Arg a, sVector31Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z + a.w;
}

inline sF32 operator ^ (sVector4Arg a, sVector4Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;
}

inline sVector2 & operator += (sVector2& a, sVector2Arg b)
{
  a = a + b;
  return a;
}

inline sVector30 & operator += (sVector30& a, sVector30Arg b)
{
  a = a + b;
  return a;
}

inline sVector31 & operator += (sVector31& a, sVector30Arg b)
{
  a = a + b;
  return a;
}

inline sVector4 & operator += (sVector4& a, const sVector4& b)
{
  a = a + b;
  return a;
}
...
inline sVector2 & operator *= (sVector2& a, sF32 s)
{
  a = a * s;
  return a;
}

inline sVector30 & operator *= (sVector30& a, sF32 s)
{
  a = a * s;
  return a;
}

inline sVector4 & operator *= (sVector4& a, sF32 s)
{
  a = a * s;
  return a;
}
...
inline sF32 sOBSOLETE dot(sVector30Arg a, sVector30Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 sOBSOLETE dot(sVector30Arg a, sVector31Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 sOBSOLETE dot(sVector31Arg a, sVector30Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 sOBSOLETE dot(sVector4Arg a, sVector31Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z + a.w;
}

inline sF32 sOBSOLETE dot(sVector31Arg a, sVector4Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z + b.w;
}

inline sF32 sOBSOLETE dot(sVector4Arg a, sVector30Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sF32 sOBSOLETE dot(sVector30Arg a, sVector4Arg b)
{
  return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline sVector30::sVector30(const sVector4& a)
{
  x = a.x;
  y = a.y;
  z = a.z;
...
inline sVector31::sVector31(const sVector30& a)
{
  x = a.x;
  y = a.y;
  z = a.z;
...
inline sVector31::sVector31(const sVector4& a)
{
  x = a.x;
  y = a.y;
  z = a.z;
...
inline sVector2 sAverage(sVector2Arg a, sVector2Arg b)
{
  return sVector2((a.x + b.x) * 0.5f, (a.y + b.y) * 0.5f);
}

inline sVector30 sAverage(sVector30Arg a, sVector30Arg b)
{
  return sVector30((a.x + b.x) * 0.5f, (a.y + b.y) * 0.5f, (a.z + b.z) * 0.5f);
}

inline sVector31 sAverage(sVector31Arg a, sVector31Arg b)
{
  return sVector31((a.x + b.x) * 0.5f, (a.y + b.y) * 0.5f, (a.z + b.z) * 0.5f);
}

inline sVector2 sUnitFast(sVector2Arg v)
{
  return v * sFRSqrt(v ^ v);
}

inline sVector30 sUnitFast(sVector30Arg v)
{
  return v * sFRSqrt(v ^ v);
}

inline sVector4 sUnitFast(sVector4Arg v)
{
  return v * sFRSqrt(v ^ v);
}

inline sWriter & operator | (sWriter& s, sVector2Arg a)
{
  s | a.x | a.y;
  return s;
}

inline sReader & operator | (sReader& s, sVector2& a)
{
  s | a.x | a.y;
  return s;
}

inline sWriter & operator | (sWriter& s, sVector30Arg a)
{
  s | a.x | a.y | a.z;
  return s;
}

inline sReader & operator | (sReader& s, sVector30& a)
{
  s | a.x | a.y | a.z;
  return s;
}

inline sWriter & operator | (sWriter& s, sVector31Arg a)
{
  s | a.x | a.y | a.z;
  return s;
}

inline sReader & operator | (sReader& s, sVector31& a)
{
  s | a.x | a.y | a.z;
  return s;
}

inline sWriter & operator | (sWriter& s, sVector4Arg a)
{
  s | a.x | a.y | a.z | a.w;
  return s;
}

inline sReader & operator | (sReader& s, sVector4& a)
{
  s | a.x | a.y | a.z | a.w;
  return s;
}
...
public:
  ...
  sQuaternion(sF32 R, sF32 I, sF32 J, sF32 K)
  {
    r = R;
    i = I;
    j = J;
  ...
  sQuaternion(sVector30Arg v, sF32 a)
  {
    sF32 si;
    sFSinCos(a / 2, si, r);
    i = si * v.x;
    j = si * v.y;
    k = si * v.z;
  } // rotation around axis v, v must be unit length, angle in radians

  void Init(sF32 R, sF32 I, sF32 J, sF32 K)
  {
    r = R;
    i = I;
    j = J;
  ...
  inline void Fade(sF32 fade, sQuaternionArg a, sQuaternionArg b)
  {
    Lerp(fade, a, b);
    Unit();
  } // also called "nlerp"
  ...
  inline void Euler(sVector30Arg v)
  {
    Euler(v.x, v.y, v.z);
  }
  ...
  inline sQuaternion Conjugate() const
  {
    return sQuaternion(r, -i, -j, -k);
  }

  inline sF32 GetNorm() const
  {
    return sSqrt(GetNormSq());
  }

  inline sF32 GetNormSq() const
  {
...
inline sQuaternion & operator *= (sQuaternion& a, sQuaternionArg b)
{
  a = a * b;
  return a;
}

inline sVector30 & operator *= (sVector30& a, sQuaternionArg b)
{
  a = a * b;
  return a;
}

inline sVector31 & operator *= (sVector31& a, sQuaternionArg b)
{
  a = a * b;
  return a;
}

inline sQuaternion operator * (sF32 s, sQuaternionArg q)
{
  return sQuaternion(s * q.r, s * q.i, s * q.j, s * q.k);
}

inline sQuaternion operator * (sQuaternionArg q, sF32 s)
{
  return sQuaternion(s * q.r, s * q.i, s * q.j, s * q.k);
}

inline sQuaternion operator + (sQuaternionArg a, sQuaternionArg b)
{
  return sQuaternion(a.r + b.r, a.i + b.i, a.j + b.j, a.k + b.k);
}
...
inline sQuaternion operator ~ (sQuaternionArg q)
{
  sQuaternion res(q);
  res.Invert();
  return res;
...
inline sF32 dot(sQuaternionArg a, sQuaternionArg b)
{
  return a.r * b.r + a.i * b.i + a.j * b.j + a.k * b.k;
}

inline sF32 operator ^ (sQuaternionArg a, sQuaternionArg b)
{
  return a.r * b.r + a.i * b.i + a.j * b.j + a.k * b.k;
}
...
inline sQuaternion sUnitFast(sQuaternionArg q)
{
  return q * sFRSqrt(q ^ q);
}

inline sWriter & operator | (sWriter& s, sQuaternionArg a)
{
  s | a.r | a.i | a.j | a.k;
  return s;
}

inline sReader & operator | (sReader& s, sQuaternion& a)
{
  s | a.r | a.i | a.j | a.k;
  return s;
}
...
public:
  ...
  explicit sMatrix34(sQuaternionArg q)
  {
    Init(q);
  }

  explicit sMatrix34(sQuaternionArg q, sVector31Arg v)
  {
    Init(q, v);
  }
  ...
  void EulerXYZ(sVector30Arg xyz)
  {
    EulerXYZ(xyz.x, xyz.y, xyz.z);
  }
...
public:
  ...
  sVector4Arg operator [] (sInt a) const
  {
    return (&i)[a];
  }
};
...
inline sMatrix44 & operator *= (sMatrix44& a, const sMatrix44& b)
{
  a = a * b;
  return a;
}

inline sMatrix34 & operator *= (sMatrix34& a, const sMatrix34& b)
{
  a = a * b;
  return a;
}
...
inline sVector30 & operator *= (sVector30& v, const sMatrix34& m)
{
  v = v * m;
  return v;
}

inline sVector31 & operator *= (sVector31& v, const sMatrix34& m)
{
  v = v * m;
  return v;
}

inline sVector4 & operator *= (sVector4& v, const sMatrix34& m)
{
  v = v * m;
  return v;
}

inline sVector4 & operator *= (sVector4& v, const sMatrix44& m)
{
  v = v * m;
  return v;
}
...
inline sWriter & operator | (sWriter& s, const sMatrix34& a)
{
  s | a.i | a.j | a.k | a.l;
  return s;
}

inline sReader & operator | (sReader& s, sMatrix34& a)
{
  s | a.i | a.j | a.k | a.l;
  return s;
}

inline sWriter & operator | (sWriter& s, const sMatrix44& a)
{
  s | a.i | a.j | a.k | a.l;
  return s;
}

inline sReader & operator | (sReader& s, sMatrix44& a)
{
  s | a.i | a.j | a.k | a.l;
  return s;
}
...
public:
  ...
  void Init(sF32 re, sF32 im)
  {
    r = re;
    i = im;
  }

  void InitUnit(sF32 re, sF32 im)
  {
    sF32 il = sFRSqrt(re * re + im * im);
    r = il * re;
    i = il * im;
  }

  sComplex & operator = (sF32 s)
  {
    r = s;
    i = 0.0f;
    return *this;
  ...
  sF32 Length() const
  {
    return sFSqrt(r * r + i * i);
  }

  void Unit()
  {
    *this *= sFRSqrt(r * r + i * i);
  }
};
...
inline sComplex operator * (sF32 s, const sComplex& a)
{
  return sComplex(s * a.r, s * a.i);
}

inline sComplex operator * (const sComplex& a, sF32 s)
{
  return sComplex(s * a.r, s * a.i);
}

inline sComplex operator - (const sComplex& a)
{
  return sComplex(-a.r, -a.i);
}
...
public:
  ...
  sVector31 Center() const
  {
    sVector31 p((Min.x + Max.x) / 2, (Min.y + Max.y) / 2, (Min.z + Max.z) / 2);
    return p;
  }

  sVector30 Size() const
  {
    sVector30 p(Max.x - Min.x, Max.y - Min.y, Max.z - Min.z);
    return p;
  }
  ...
  sF32 DistanceTo(sVector31Arg p) const
  {
    return sFSqrt(DistanceToSq(p));
  }

  sInt Classify(sVector30Arg n, sF32 d);

  sAABBox & operator *= (const sMatrix34& m);
  sBool operator == (const sAABBox& b) const
  {
    return Min == b.Min && Max == b.Max;
  }
};

inline sAABBox operator * (const sAABBox& bbox, const sMatrix34& m)
{
  sAABBox r = bbox;
  r *= m;
  return r;
...
inline sWriter & operator | (sWriter& s, const sAABBox& a)
{
  s | a.Min | a.Max;
  return s;
}

inline sReader & operator | (sReader& s, sAABBox& a)
{
  s | a.Min | a.Max;
  return s;
}
...
inline sWriter & operator | (sWriter& s, const sOBBox& b)
{
  return s | b.BoxToWorld | b.Center | b.HalfExtents;
}

inline sReader & operator | (sReader& s, sOBBox& b)
{
  return s | b.BoxToWorld | b.Center | b.HalfExtents;
}
...
inline sRay operator * (const sRay& r, const sMatrix34& m)
{
  sRay x(r.Start * m, r.Dir * m);
  return x;
}
...
inline sWriter & operator | (sWriter& s, const sRay& a)
{
  s | a.Start | a.Dir;
  return s;
}

inline sReader & operator | (sReader& s, sRay& a)
{
  s | a.Start | a.Dir;
  return s;
}
...
struct s3DRect
{
  ...
  void InitBorder(sVector31Arg bottomLeft, sVector30Arg widthVector, sVector30Arg heightVector)
  {
    Right = widthVector * 0.5f;
    Up = heightVector * 0.5f;
    Center = bottomLeft + Up + Right;
  }

  void InitCenter(sVector31Arg center, sVector30Arg upVector, sVector30Arg rightVector)
  {
    Center = center;
    Up = upVector;
    Right = rightVector;
  ...
  sVector31 BottomLeft()  const
  {
    return Center - Up - Right;
  }

  sVector31 TopRight()    const
  {
    return Center + Up + Right;
  }

  sVector31 TopLeft()     const
  {
    return Center + Up - Right;
  }

  sVector31 BottomRight() const
  {
    return Center - Up + Right;
  }
};
...
inline sWriter & operator | (sWriter& s, const sSRT& a)
{
  s | a.Scale | a.Rotate | a.Translate;
  return s;
}

inline sReader & operator | (sReader& s, sSRT& a)
{
  s | a.Scale | a.Rotate | a.Translate;
  return s;
}
...
inline sF32 sSmoothStep(sF32 x)
{
  x = sClamp<sF32>(x, 0, 1);
  return (x * x) * 3 - (x * x) * x * 2;
}

inline sF32 sSmoothStep(sF32 min, sF32 max, sF32 x)
{
  return sSmoothStep((x - min) / (max - min));
}
...
template<typename T>
inline T sGetBezierSplinePoint(sF32 n, const T& v1, const T& v2, const T& v3)
{
  T out;
  sGetBezierSplinePoint(&out[0], n, &v1[0], &v2[0], &v3[0], T::Dimensions);
  return out;
}

template<typename T>
inline T sGetBezierSplinePoint(sF32 n, const T& v1, const T& v2, const T& v3, const T& v4)
{
  T out;
  sGetBezierSplinePoint(&out[0], n, &v1[0], &v2[0], &v3[0], &v4[0], T::Dimensions);
  return out;
}
...
template<class RndClass>
class MarkovRandom
{
public:
  MarkovRandom(sInt elements /*!< [in] defines the range of generated values (0 .. elements-1) */, sU32 seed /*!< [in] internal random generator seed */)
  {
    Rnd.Seed(seed);
  ...
  sInt GetNextRandom()
  {
    ...
    if(Probabilities.GetCount() == 0)
      return 0;

    // prepare summed up temp
    Temp[0] = Probabilities[0];

    for(sInt i = 1; i < Temp.GetCount(); i++)
    ...
    while((idx < Temp.GetCount()) && (Temp[idx] <= r))
      idx++;
