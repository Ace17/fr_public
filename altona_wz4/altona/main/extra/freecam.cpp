...
void sFreeflightCamera::OnInput(const sInput2Event& ie)
{
  ...
  case sKEY_LMB:              LMB = 1;
    break;
  case sKEY_LMB | sKEYQ_BREAK:  LMB = 0;
    break;
  case sKEY_RMB:              RMB = 1;
    break;
  case sKEY_RMB | sKEYQ_BREAK:  RMB = 0;
    break;
  case sKEY_WHEELUP:          SpeedGrade = sClamp<sF32>(SpeedGrade + 1, -40, 20);
    break;
  case sKEY_WHEELDOWN:        SpeedGrade = sClamp<sF32>(SpeedGrade - 1, -40, 20);
    break;
  }
