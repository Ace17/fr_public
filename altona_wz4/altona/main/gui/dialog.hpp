...
sPRINTING1(sErrorDialogF, sString<1024> tmp;
           sFormatStringBuffer buf = sFormatStringBase(tmp, format);
           buf, sErrorDialog(arg1, (const sChar*)tmp);
           , const sMessage &)
sPRINTING1(sOkDialogF, sString<1024> tmp;
           sFormatStringBuffer buf = sFormatStringBase(tmp, format);
           buf, sOkDialog(arg1, (const sChar*)tmp);
           , const sMessage &)
sPRINTING2(sOkCancelDialogF, sString<1024> tmp;
           sFormatStringBuffer buf = sFormatStringBase(tmp, format);
           buf, sOkCancelDialog(arg1, arg2, (const sChar*)tmp);
           , const sMessage &, const sMessage &)
sPRINTING2(sYesNoDialogF, sString<1024> tmp;
           sFormatStringBuffer buf = sFormatStringBase(tmp, format);
           buf, sYesNoDialog(arg1, arg2, (const sChar*)tmp);
           , const sMessage &, const sMessage &)
