...
public:
  ...
  sBool HandleShortcut(sWindow* win, sU32 key)
  {
    return 0;
  }
  ...
  template<class T>
  void AddParaInt(const sChar* classname, const sChar* commandname, const sMessage& msg, sInt T::* ptr, sF32 min, sF32 max, sF32 step)
  {
    AddPara1(classname, commandname, msg, sWPT_INT, (sDInt)(&(((T*)0)->*ptr)), 0, min, max, step);
  }

  template<class T>
  void AddParaFloat(const sChar* classname, const sChar* commandname, const sMessage& msg, sF32 T::* ptr, sF32 min, sF32 max, sF32 step)
  {
    AddPara1(classname, commandname, msg, sWPT_FLOAT, (sDInt)(&(((T*)0)->*ptr)), 0, min, max, step);
  }

  template<class T>
  void AddParaChoice(const sChar* classname, const sChar* commandname, const sMessage& msg, sInt T::* ptr, const sChar* choices)
  {
    AddPara1(classname, commandname, msg, sWPT_CHOICE, (sDInt)(&(((T*)0)->*ptr)), choices, 0, 0, 0);
  }

  template<class T>
  void AddParaBool(const sChar* classname, const sChar* commandname, const sMessage& msg, sInt T::* ptr)
  {
    AddPara1(classname, commandname, msg, sWPT_CHOICE, (sDInt)(&(((T*)0)->*ptr)), L"off|on", 0, 0, 0);
  }
...
// template<class T> void AddParaColor (const sChar *classname,const sChar *commandname,const sMessage &msg,sU32 T::*ptr,sBool alpha)                 { AddPara1(classname,commandname,msg,sInt(alpha?sWPT_ARGB:sWPT_RGB),(sDInt)(&(((T*)0)->*ptr))); }
  ...
  const sChar* GetCurrentToolName()
  {
...
public:
  ...
  virtual sBool OnCheckHit(const sWindowDrag& dd)
  {
    return 0;
  }
  ...
  {
    return sWire->HandleKey(this, key);
  }

  sBool OnCommand(sInt cmd)
  {
    return sWire->HandleCommand(this, cmd);
  }
  ...
  void CmdMaximize()
  {
    sWire->SetFullscreen(this, 1);
  }     // maximise this windows
