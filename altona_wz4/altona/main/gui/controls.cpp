...
void sButtonControl::MakeShortcut(sString<64>& buffer, sU32 Shortcut)
{
  ...
  if(Shortcut)
  {
    ...
    switch(s[0])
    {
    default:              buffer.Add(s);
      break;
    case sKEY_UP:         buffer.Add(L"up");
      break;
    case sKEY_DOWN:       buffer.Add(L"down");
      break;
    case sKEY_LEFT:       buffer.Add(L"left");
      break;
    case sKEY_RIGHT:      buffer.Add(L"right");
      break;
    case sKEY_HOME:       buffer.Add(L"home");
      break;
    case sKEY_END:        buffer.Add(L"end");
      break;
    case sKEY_PAGEUP:     buffer.Add(L"pageup");
      break;
    case sKEY_PAGEDOWN:   buffer.Add(L"pagedown");
      break;
    case sKEY_INSERT:     buffer.Add(L"insert");
      break;
    case sKEY_DELETE:     buffer.Add(L"delete");
      break;
    case sKEY_WHEELUP:    buffer.Add(L"wheelup");
      break;
    case sKEY_WHEELDOWN:  buffer.Add(L"wheeldown");
      break;

    case sKEY_PAUSE:      buffer.Add(L"pause");
      break;
    case sKEY_PRINT:      buffer.Add(L"print");
      break;
    case sKEY_WINM:       buffer.Add(L"menu");
      break;

    case sKEY_BACKSPACE:  buffer.Add(L"backspace");
      break;
    case sKEY_TAB:        buffer.Add(L"tab");
      break;
    case sKEY_ENTER:      buffer.Add(L"enter");
      break;
    case sKEY_ESCAPE:     buffer.Add(L"escape");
      break;
    case sKEY_SPACE:      buffer.Add(L"space");
      break;
    case sKEY_LMB:        buffer.Add(L"LMB");
      break;
    case sKEY_RMB:        buffer.Add(L"RMB");
      break;
    case sKEY_MMB:        buffer.Add(L"MMB");
      break;
    case sKEY_X1MB:       buffer.Add(L"4MB");
      break;
    case sKEY_X2MB:       buffer.Add(L"5MB");
      break;
    case sKEY_HOVER:      buffer.Add(L"hover");
      break;

    case sKEY_F1:         buffer.Add(L"F1");
      break;
    case sKEY_F2:         buffer.Add(L"F2");
      break;
    case sKEY_F3:         buffer.Add(L"F3");
      break;
    case sKEY_F4:         buffer.Add(L"F4");
      break;
    case sKEY_F5:         buffer.Add(L"F5");
      break;
    case sKEY_F6:         buffer.Add(L"F6");
      break;
    case sKEY_F7:         buffer.Add(L"F7");
      break;
    case sKEY_F8:         buffer.Add(L"F8");
      break;
    case sKEY_F9:         buffer.Add(L"F9");
      break;
    case sKEY_F10:        buffer.Add(L"F10");
      break;
    case sKEY_F11:        buffer.Add(L"F11");
      break;
    case sKEY_F12:        buffer.Add(L"F12");
      break;
    }
  }
}
...
template<>
const sChar* sByteControl::ClassName()
{
  return L"sByteControl";
}

template<>
void sValueControl<sU8>::MoreInit()
{
  RightStep = 0.25f;
}

template<>
sBool sValueControl<sU8>::MakeBuffer(sBool unconditional)
{
...
template<>
sBool sValueControl<sU8>::ParseBuffer()
{
  const sChar* s = String;
  sInt val;
  sBool ok = 1;
...
template<>
void sValueControl<sU8>::OnPaint2D()
{
  if(ColorPtr)
  {
...
template<>
const sChar* sWordControl::ClassName()
{
  return L"sWordControl";
}

template<>
void sValueControl<sU16>::MoreInit()
{
  RightStep = 0.25f;
}

template<>
sBool sValueControl<sU16>::MakeBuffer(sBool unconditional)
{
  if(unconditional || *Value != OldValue)
  {
    OldValue = *Value;
...
template<>
sBool sValueControl<sU16>::ParseBuffer()
{
  const sChar* s = String;
  sInt val;
  sBool ok = 1;
...
template<>
void sValueControl<sU16>::OnPaint2D()
{
  if(ColorPtr)
  {
    BackColor = 0xff000000 | (ColorPtr[2] << 16) | (ColorPtr[1] << 8) | (ColorPtr[0] << 0);
...
template<>
const sChar* sIntControl::ClassName()
{
  return L"sIntControl";
}

template<>
void sValueControl<sInt>::MoreInit()
{
  RightStep = 0.25f;
}

template<>
sBool sValueControl<sInt>::MakeBuffer(sBool unconditional)
{
  if(unconditional || *Value != OldValue)
  {
    OldValue = *Value;
...
template<>
sBool sValueControl<sInt>::ParseBuffer()
{
  const sChar* s = String;
  sInt val;
  sBool ok = 1;
...
template<>
void sValueControl<sInt>::OnPaint2D()
{
  if(ColorPtr)
  {
...
template<>
const sChar* sFloatControl::ClassName()
{
  return L"sFloatControl";
}

template<>
void sValueControl<sF32>::MoreInit()
{
  RightStep = 0.125f;
}

template<>
sBool sValueControl<sF32>::MakeBuffer(sBool unconditional)
{
  if(unconditional || *Value != OldValue)
  {
    OldValue = *Value;
...
template<>
sBool sValueControl<sF32>::ParseBuffer()
{
  const sChar* s = String;
  sF32 val;
  sBool ok = 1;
...
template<>
void sValueControl<sF32>::OnPaint2D()
{
  if(ColorPtr)
  {
