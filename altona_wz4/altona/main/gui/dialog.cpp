...
sBool sFindWindow::OnKey(sU32 key)
{
  ...
  case sKEY_DOWN:
    ...
    if(Selected < IncList.GetCount() - 1)
      Selected++;
...
public:
  sGuiThemeEditWindow(sGuiTheme& theme, sBool live) : Theme(theme), Live(live)
  {
    ...
    gh.ColorPick(&Theme.BackColor, L"rgb", 0);
    gh.Label(L"Document");
    gh.ColorPick(&Theme.DocColor, L"rgb", 0);
    gh.Label(L"Text");
    gh.ColorPick(&Theme.TextColor, L"rgb", 0);
    gh.Label(L"Buttons");
    gh.ColorPick(&Theme.ButtonColor, L"rgb", 0);
    gh.Label(L"Draw");
    gh.ColorPick(&Theme.DrawColor, L"rgb", 0);
    gh.Label(L"Selection");
    gh.ColorPick(&Theme.SelectColor, L"rgb", 0);
    gh.Label(L"Higher");
    gh.ColorPick(&Theme.HighColor2, L"rgb", 0);
    gh.Label(L"High");
    gh.ColorPick(&Theme.HighColor, L"rgb", 0);
    gh.Label(L"Low");
    gh.ColorPick(&Theme.LowColor, L"rgb", 0);
    gh.Label(L"Lower");
    gh.ColorPick(&Theme.LowColor2, L"rgb", 0);

    gh.Group(L"Fonts");
    gh.Label(L"Proportional");
    gh.String(Theme.PropFont);
    gh.Label(L"Fixed Width");
    gh.String(Theme.FixedFont);
