...
sINLINE sInt sAddNetDebugPlugin(sHTTPServer::HandlerCreateFunc, const sChar* name, const sChar* path = 0)
{
  return sTRUE;
}

sINLINE sInt sAddNetDebugFile(const sChar* path, const sU8* buffer, sDInt size)
{
  return sTRUE;
}
