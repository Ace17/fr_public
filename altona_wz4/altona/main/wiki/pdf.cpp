...
sInt sPDF::RegisterFont(sInt flags, sFont2D* font)
{
  ...
  switch(flags)
  {
  case sPDF_Regular | sPDF_Times:     name = L"Times-Roman";
    break;
  case sPDF_Bold | sPDF_Times:     name = L"Times-Bold";
    break;
  case sPDF_Italic | sPDF_Times:     name = L"Times-Italic";
    break;
  case sPDF_BoldItalic | sPDF_Times:     name = L"Times-BoldItalic";
    break;
  case sPDF_Regular | sPDF_Courier:   name = L"Courier";
    break;
  case sPDF_Bold | sPDF_Courier:   name = L"Courier-Bold";
    break;
  case sPDF_Italic | sPDF_Courier:   name = L"Courier-Oblique";
    break;
  case sPDF_BoldItalic | sPDF_Courier:   name = L"Courier-BoldOblique";
    break;
  case sPDF_Regular | sPDF_Helvetica: name = L"Helvetica";
    break;
  case sPDF_Bold | sPDF_Helvetica: name = L"Helvetica-Bold";
    break;
  case sPDF_Italic | sPDF_Helvetica: name = L"Helvetica-Oblique";
    break;
  case sPDF_BoldItalic | sPDF_Helvetica: name = L"Helvetica-BoldOblique";
    break;
  case sPDF_Symbol:                    name = L"Symbol";
    break;
  case sPDF_Dingbats:                  name = L"ZapfDingbats";
    break;
  }
