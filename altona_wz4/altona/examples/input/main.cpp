...
void MyApp::PrintInput()
{
  ...
  sInt y = 10;
  Painter->PrintF(10, y, L"%5.2ffps %5.3fms", 1000 / avg, avg);
  y += 10;
  ...
  {
    sInput2Device* device = sFindInput2Device(deviceType, i);
    Painter->PrintF(10, y, L"mouse   %d:", i);
    y += 10;
    PrintInput2Device(device, y);
  }
  ...
  if(device)
  {
    ...
    if(!device->IsStatus(sINPUT2_STATUS_ERROR))
    {
      ...
      sFORALL(sv, val)
      {
        ...
        {
          Painter->PrintF(10, y, L"%s", tb.Get());
          y += 10;
          tb.Clear();
          printedCount = 0;
        }
    ...
    {
      Painter->PrintF(10, y, L"  disconnected/error");
      y += 10;
    }
  }
}
