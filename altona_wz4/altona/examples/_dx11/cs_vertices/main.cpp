...
MyApp::MyApp()
{
  ...
  CSIB = new sCSBuffer(sTEX_BUFFER | sTEX_RAW | sTEX_CS_INDEX | sTEX_CS_WRITE, DIM * DIM * DIM * 4);
  ...
  sImage img(64, 64);
  img.Fill(0x00000000);
  img.Glow(0.5f, 0.5f, 0.5f, 0.5f, 0x00202020, 1.0f, 1.0f);
