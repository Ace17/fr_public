...
inline sInt sRange(sInt val, sInt max, sInt min)
{
  return sClamp(val, min, max);
}
    ...
    for(y = 0; y < sizeY / 4; y++)
    {
      ...
      for(x = 0; x < sizeX / 4; x++)
      {
          ...
          if(format == BITMAP_DXT5)
          {
            ...
            if(maxmin && maxmax)
            {
              *d = amin + (amax << 8);
              ...
              ablend[1] = amin;
              bitcode[1] = 0x00;
              ablend[2] = (4 * amin + 1 * amax) / 5;
              bitcode[2] = 0x02;
              ablend[3] = (3 * amin + 2 * amax) / 5;
              bitcode[3] = 0x03;
              ablend[4] = (2 * amin + 3 * amax) / 5;
              bitcode[4] = 0x04;
              ablend[5] = (1 * amin + 4 * amax) / 5;
              bitcode[5] = 0x05;
              ablend[6] = amax;
              bitcode[6] = 0x01;
              ablend[7] = 0xFF;
            ...
            else
            {
              ...
              *d = amax + (amin << 8);
              ablend[0] = amin;
              bitcode[0] = 0x01;
              ablend[1] = (6 * amin + 1 * amax) / 7;
              bitcode[1] = 0x07;
              ablend[2] = (5 * amin + 2 * amax) / 7;
              bitcode[2] = 0x06;
              ablend[3] = (4 * amin + 3 * amax) / 7;
              bitcode[3] = 0x05;
              ablend[4] = (3 * amin + 4 * amax) / 7;
              bitcode[4] = 0x04;
              ablend[5] = (2 * amin + 5 * amax) / 7;
              bitcode[5] = 0x03;
              ablend[6] = (1 * amin + 6 * amax) / 7;
              bitcode[6] = 0x02;
              ablend[7] = amax;
              bitcode[7] = 0x00;
            }
        ...
        for(c = 0; c < 3; c++)
        {
          ...
          c1 = color1;
          c2 = color2;
          start1 = *p - scanrange / 2;
          start1 = sRange(start1, 0xFF, 0x00);
          end1 = start1 + scanrange;
          end1 = sRange(end1, 0xFF, 0x00);
          start2 = *q - scanrange / 2;
          start2 = sRange(start2, 0xFF, 0x00);
          end2 = start2 + scanrange;
          end2 = sRange(end2, 0xFF, 0x00);
