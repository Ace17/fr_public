...
static SortFunc1 sortFuncs1[] =
{
  &SortFuncHeapOld<sInt>, &SortFuncHeapNew<sInt>, &SortFuncSTL<sInt>, &SortFuncIntro<sInt>
};
static const sChar* sortFuncNames[sCOUNTOF(sortFuncs1)] =
{
  L"heap old", L"heap new", L"stl", L"intro"
};
...
static SortFunc2 sortFuncs2[] =
{
  &SortFuncHeapOld<FakeVertex>, &SortFuncHeapNew<FakeVertex>, &SortFuncSTL<FakeVertex>, &SortFuncIntro<FakeVertex>
};
